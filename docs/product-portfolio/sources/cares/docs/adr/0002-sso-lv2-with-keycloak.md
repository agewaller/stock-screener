...
- Status: **Superseded by [ADR-0014](0014-auth-switch-to-identity-platform.md) (2026-05-26)**
- Date: 2026-05-26
- Deciders: オーナー、Claude（提案）

> **改訂注記 (2026-05-26)**: 本 ADR の中央 IdP = Keycloak セルフホスト方針は撤回。
> オーナー指示により、認証基盤を GCP Identity Platform (Firebase Auth) に置き換えた (ADR-0014)。
> ValuationMatrix / zen-track との SSO 連携は同じ Identity Platform を共有する形に再設計予定。
> 本ファイルの「Decision」以降は **過去の決定の記録** として残す。
