...
(function () {
  ...
  var CATALOGS = {
    ...
    obesity: {
      title: '📚 肥満症の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『肥満症治療ガイドブック — GLP-1・行動変容・外科手術まで』', q: '肥満症 治療 GLP-1 行動変容 外科 ガイドブック 本' },
        { kind: 'device', label: '体組成計（体脂肪率・内臓脂肪・BMIを継続測定）', q: '体組成計 体脂肪 内臓脂肪 BMI タニタ オムロン スマート体重計' },
        { kind: 'book', label: '『間欠的断食（16:8断食）完全ガイド』', q: '間欠的断食 16 8 インターミッテントファスティング 本 ガイド' },
        { kind: 'supplement', label: '食物繊維サプリ（満腹感・血糖スパイク抑制）', q: '食物繊維 サプリ 満腹 血糖 スパイク 抑制 オオバコ' },
        { kind: 'device', label: '歩数計・スマートウォッチ（活動量の毎日トラッキング）', q: 'スマートウォッチ 歩数計 活動量 カロリー フィットネス' }
      ]
    },
    neuropathy: {
      title: '📚 末梢神経障害（ニューロパチー）の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『糖尿病神経障害・末梢神経障害の最新治療』', q: '糖尿病 神経障害 末梢 ニューロパチー 治療 本' },
        { kind: 'supplement', label: 'ビタミンB1（チアミン/ベンフォチアミン）— 神経機能サポート', q: 'ビタミンB1 チアミン ベンフォチアミン 神経 末梢 サプリ' },
        { kind: 'supplement', label: 'α-リポ酸（ALA）— 神経障害性疼痛の緩和', q: 'アルファリポ酸 ALA α-リポ酸 神経 しびれ サプリ 糖尿病' },
        { kind: 'device', label: 'TENS装置（経皮的電気神経刺激による疼痛緩和）', q: 'TENS 電気刺激 疼痛 しびれ 神経 家庭用 低周波' }
      ]
    },
    adrenal: {
      title: '📚 副腎機能不全の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『副腎疲労症候群 — コルチゾール・ストレス・回復の完全ガイド』', q: '副腎疲労 コルチゾール ストレス 回復 本 副腎機能' },
        { kind: 'supplement', label: 'ビタミンC（副腎の抗酸化・ストレス応答サポート）', q: 'ビタミンC 副腎 抗酸化 ストレス サプリ アスコルビン酸 高容量' },
        { kind: 'supplement', label: 'ビタミンB5（パントテン酸）— 副腎ホルモン合成サポート', q: 'パントテン酸 ビタミンB5 副腎 ホルモン サプリ 副腎疲労' },
        { kind: 'device', label: '唾液コルチゾール検査キット（ストレスホルモン測定）', q: '唾液 コルチゾール 検査 キット ストレス ホルモン 測定 セルフ' },
        { kind: 'book', label: '『アジソン病・副腎不全 — 患者のための生活管理ガイド』', q: 'アジソン病 副腎不全 副腎機能低下 生活 管理 本 患者' }
      ]
    },
    diabetes_t1: {
      title: '📚 1型糖尿病の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『1型糖尿病のすべて — インスリン療法・CGM・生活管理』', q: '1型糖尿病 インスリン 療法 CGM 管理 本 完全ガイド' },
        { kind: 'device', label: '連続血糖測定（CGM）用品・センサー補助アクセサリー', q: 'CGM 連続血糖 センサー アクセサリー リブレ フリースタイル 固定 カバー' },
        { kind: 'supplement', label: 'ビタミンD3（免疫調節・β細胞保護）', q: 'ビタミンD3 免疫 β細胞 糖尿病 サプリ 5000IU' },
        { kind: 'device', label: 'インスリン保冷バッグ・携帯ケース', q: 'インスリン 保冷 バッグ 携帯 ケース 医療 冷却 旅行' },
        { kind: 'book', label: '『カーボカウント実践ガイド — 食事と血糖コントロール』', q: 'カーボカウント 炭水化物 糖質 インスリン 食事 血糖 本' }
      ]
    },
    diabetes_t2: {
      title: '📚 2型糖尿病の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『2型糖尿病 — 食事・運動・薬の最新エビデンスガイド』', q: '2型糖尿病 食事 運動 薬 治療 ガイド 本 血糖 HbA1c' },
        { kind: 'device', label: '血糖測定器・センサー（自己血糖測定用）', q: '血糖測定器 センサー 自己血糖 血糖計 グルコメーター' },
        { kind: 'book', label: '『ベジファースト・糖質制限レシピ — 血糖スパイクを防ぐ料理』', q: 'ベジファースト 糖質制限 レシピ 血糖 スパイク 料理 本 糖尿病食' },
        { kind: 'supplement', label: '食物繊維サプリ（食後血糖の急上昇を抑える）', q: '食物繊維 サプリ 血糖 スパイク 抑制 オオバコ イヌリン' },
        { kind: 'device', label: '体組成計（体脂肪・内臓脂肪・BMI管理）', q: '体組成計 体脂肪 内臓脂肪 BMI タニタ オムロン スマート体重計' }
      ]
    },
    lyme: {
      title: '📚 慢性ライム病の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『ライム病・慢性疾患 — 症状・診断・回復のガイド』', q: 'ライム病 慢性 ボレリア 症状 診断 回復 本 マダニ' },
        { kind: 'device', label: 'ダニ除去ピンセット・マダニチェックカード', q: 'マダニ 除去 ピンセット ダニ 取り方 ダニ取り 野外 登山' },
        { kind: 'supplement', label: 'マグネシウム（関節痛・筋肉痛・睡眠サポート）', q: 'マグネシウム グリシン酸 サプリ 関節痛 筋肉痛 睡眠 抗炎症' },
        { kind: 'supplement', label: 'コエンザイムQ10（細胞エネルギー・疲労回復サポート）', q: 'コエンザイムQ10 CoQ10 疲労 エネルギー 慢性疲労 サプリ' }
      ]
    },
    arrhythmia: {
      title: '📚 不整脈の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『不整脈・心房細動 — 患者のための最新治療ガイド』', q: '不整脈 心房細動 患者 治療 アブレーション ガイド 本' },
        { kind: 'device', label: 'スマートウォッチ・携帯心電計（AFib検出）', q: 'スマートウォッチ 心電図 不整脈 AFib 検出 ウェアラブル Apple Watch' },
        { kind: 'supplement', label: 'マグネシウム（心臓リズム・電解質バランスサポート）', q: 'マグネシウム サプリ 心臓 リズム 不整脈 電解質 心房細動' },
        { kind: 'device', label: '血圧計（心拍不整検出機能付き）', q: '血圧計 心拍 不整 検出 オムロン タニタ 家庭用 上腕式' },
        { kind: 'supplement', label: 'オメガ3 EPA/DHA（抗炎症・心臓保護）', q: 'オメガ3 EPA DHA 心臓 不整脈 抗炎症 フィッシュオイル サプリ' }
      ]
    },
    tbi: {
      title: '📚 外傷性脳損傷後遺症（TBI）の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『高次脳機能障害 — 家族・支援者のためのガイドブック』', q: '高次脳機能障害 家族 支援 ガイドブック リハビリ 脳損傷 TBI 本' },
        { kind: 'device', label: 'スマートフォン向け記憶補助アプリ・デジタルノート', q: 'デジタルノート 手帳 記憶補助 スケジュール管理 認知 補助 ツール' },
        { kind: 'supplement', label: 'オメガ3 DHA（神経保護・認知機能サポート）', q: 'オメガ3 DHA EPA 神経 認知 脳 サプリ 神経保護 フィッシュオイル' },
        { kind: 'book', label: '『脳振盪・脳損傷後のリハビリ実践ガイド』', q: '脳振盪 脳損傷 リハビリ 高次脳 認知 疲労 回復 実践 本' }
      ]
    },
    eating: {
      title: '📚 摂食障害の回復に役立つリソース',
      items: [
        { kind: 'book', label: '『摂食障害 — 神経性やせ症・過食症の正しい理解と回復』', q: '摂食障害 神経性やせ症 過食症 拒食症 回復 本 理解 治療' },
        { kind: 'book', label: '『家族のための摂食障害サポートガイド』', q: '摂食障害 家族 サポート ガイド 拒食症 過食症 支援 回復 本' },
        { kind: 'supplement', label: 'マルチビタミン・ミネラル（栄養リハビリ期のサポート）', q: 'マルチビタミン ミネラル 栄養補助 回復 サプリ 亜鉛 鉄分 B12' },
        { kind: 'book', label: '『弁証法的行動療法（DBT）自己学習ワークブック』', q: 'DBT 弁証法的行動療法 ワークブック 感情調節 自己学習 マインドフルネス 本' }
      ]
    },
    ihd: {
      title: '📚 虚血性心疾患（狭心症・心筋梗塞）の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『冠動脈疾患・狭心症・心筋梗塞の再発予防ガイド』', q: '冠動脈疾患 狭心症 心筋梗塞 再発予防 二次予防 心臓 本 ガイド' },
        { kind: 'supplement', label: 'オメガ3 EPA（血中中性脂肪低下・心臓保護）', q: 'オメガ3 EPA 中性脂肪 心臓 虚血 冠動脈 フィッシュオイル サプリ' },
        { kind: 'device', label: '血圧計（毎日の血圧・心拍数管理）', q: '血圧計 家庭用 上腕式 オムロン 心拍 血圧管理 二次予防 心臓病' },
        { kind: 'book', label: '『地中海食レシピ — 心臓病予防・脂質管理の食事法』', q: '地中海食 レシピ 心臓 脂質 コレステロール 血圧 食事療法 本' },
        { kind: 'device', label: 'パルスオキシメーター（血中酸素飽和度・心拍数測定）', q: 'パルスオキシメーター 血中酸素 心拍 SpO2 家庭用 指先' }
      ]
    },
    substance: {
      title: '📚 物質依存症の回復に役立つリソース',
      items: [
        { kind: 'book', label: '『アルコール依存症 — 医師が教える断酒・回復・再発予防』', q: 'アルコール依存症 断酒 回復 再発予防 本 医師 治療 AUDIT' },
        { kind: 'book', label: '『依存症の家族へ — アラノン・共依存・回復の手引き』', q: 'アラノン アラノン 共依存 依存症 家族 支援 回復 本' },
        { kind: 'supplement', label: 'ビタミンB1（チアミン）— アルコール離脱・ウェルニッケ予防', q: 'チアミン ビタミンB1 アルコール 離脱 ウェルニッケ 神経 サプリ' },
        { kind: 'book', label: '『SMART Recovery — 依存症の自助プログラム実践書』', q: 'SMART Recovery 依存症 自助 プログラム CBT 認知行動療法 本 回復' }
      ]
    },
    mcs: {
      title: '📚 化学物質過敏症（MCS）の対処に役立つリソース',
      items: [
        { kind: 'book', label: '『化学物質過敏症・香害 — 症状・環境整備・社会生活のガイド』', q: '化学物質過敏症 MCS 香害 症状 環境整備 本 生活 シックハウス' },
        { kind: 'device', label: '空気清浄機（活性炭フィルター・VOC対応）', q: '空気清浄機 活性炭 VOC 化学物質 シックハウス フィルター 高性能' },
        { kind: 'device', label: '化学物質対応マスク（活性炭入り・低臭）', q: 'マスク 活性炭 化学物質 VOC 香料 有害ガス 対応 防毒' },
        { kind: 'supplement', label: 'グルタチオン（解毒・抗酸化サポート）', q: 'グルタチオン 解毒 抗酸化 化学物質 サプリ NAC システイン' }
      ]
    },
    gastroparesis: {
      title: '📚 胃不全麻痺の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『胃不全麻痺・消化管運動障害 — 食事療法と生活管理』', q: '胃不全麻痺 胃排出遅延 消化管 食事療法 管理 本 ガスパレジス' },
        { kind: 'supplement', label: 'ジンジャー（生姜）サプリ — 胃の蠕動運動促進', q: 'ジンジャー 生姜 サプリ 消化 胃 蠕動 運動 吐き気 胃不全' },
        { kind: 'device', label: '栄養補助食品（液体経腸栄養・高カロリー飲料）', q: '経腸栄養 液体 栄養補助 高カロリー 飲料 アミノ酸 胃不全 消化吸収' },
        { kind: 'book', label: '『胃排出遅延レシピ — やわらか・低繊維・少量頻回食の料理』', q: '胃不全麻痺 消化 やわらか 低繊維 流動食 少量 レシピ 料理 本' }
      ]
    },
    immunodeficiency: {
      title: '📚 免疫不全症の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『原発性免疫不全症 — 患者と家族のためのガイド』', q: '原発性免疫不全症 CVID PID 患者 家族 ガイド 感染予防 本' },
        { kind: 'supplement', label: 'ビタミンD3（免疫機能調節サポート）', q: 'ビタミンD3 免疫 調節 感染予防 サプリ 5000IU 免疫不全' },
        { kind: 'device', label: 'パルスオキシメーター（感染症早期検知・血中酸素モニタリング）', q: 'パルスオキシメーター 血中酸素 SpO2 感染 早期 モニタリング 免疫不全' },
        { kind: 'book', label: '『感染症予防の科学 — 免疫機能を守る生活習慣』', q: '感染症予防 免疫 生活習慣 手洗い マスク 科学 本 免疫不全' }
      ]
    },
    allergy: {
      title: '📚 アレルギー疾患の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『アレルギー疾患治療ガイド — 食物・薬物・アナフィラキシー対策』', q: 'アレルギー 食物 薬物 アナフィラキシー 対策 治療 本 ガイド エピペン' },
        { kind: 'device', label: 'アドレナリン自己注射（エピペン）ポーチ・携帯ケース', q: 'エピペン アドレナリン 自己注射 携帯 ポーチ ケース アナフィラキシー' },
        { kind: 'supplement', label: 'ビタミンD3（免疫調節・アレルギー反応軽減）', q: 'ビタミンD3 免疫調節 アレルギー 花粉症 サプリ 免疫バランス' },
        { kind: 'book', label: '『食物アレルギーレシピ — 卵・乳・小麦なしの安心料理』', q: '食物アレルギー レシピ 除去食 卵なし 乳なし 小麦なし 料理 本' },
        { kind: 'device', label: '空気清浄機（花粉・ダニ・ハウスダスト対応）', q: '空気清浄機 花粉 ダニ ハウスダスト アレルギー 対応 HEPA フィルター' }
      ]
    }
  };
