...
(function () {
  ...
  var CATALOGS = {
    ...
    obesity: {
      title: '📚 肥満症・ダイエット管理に役立つリソース',
      items: [
        { kind: 'book', label: '『肥満症・メタボリックシンドロームの治療』', q: '肥満症 メタボリックシンドローム 治療 本' },
        { kind: 'device', label: '体組成計（体脂肪率・内臓脂肪レベル・筋肉量）', q: '体組成計 スマート 内臓脂肪 体脂肪率' },
        { kind: 'device', label: 'スマートウォッチ（歩数・カロリー消費）', q: 'スマートウォッチ 歩数 カロリー 消費' },
        { kind: 'supplement', label: '食物繊維（サイリウム・イヌリン）血糖値対策', q: 'サイリウム 食物繊維 血糖 コレステロール' }
      ]
    },
    gerd: {
      title: '📚 逆流性食道炎（GERD）の自己管理に役立つリソース',
      items: [
        { kind: 'book', label: '『逆流性食道炎がよくわかる本』', q: '逆流性食道炎 よくわかる 本' },
        { kind: 'device', label: '楔形インクライン枕（頭部挙上・夜間逆流防止）', q: '楔形 傾斜 枕 逆流性食道炎 インクライン' },
        { kind: 'supplement', label: 'アルギン酸ナトリウム（ガビスコン相当・胃酸バリア）', q: 'アルギン酸 胃酸 逆流 バリア' },
        { kind: 'device', label: '食後血糖・胃排出モニター（グルコース連続測定）', q: 'CGM 連続血糖測定 フリースタイルリブレ' }
      ]
    },
    lyme: {
      title: '📚 ライム病・感染症管理のリソース',
      items: [
        { kind: 'book', label: '『ライム病・慢性感染症の真実：診断から回復まで』', q: 'ライム病 慢性感染症 診断 回復 本' },
        { kind: 'supplement', label: 'プロバイオティクス（抗生物質使用中の腸内フローラ維持）', q: 'プロバイオティクス 抗生物質 腸内フローラ 乳酸菌' },
        { kind: 'device', label: '防虫スプレー・マダニ忌避剤（DEET/ピカリジン配合）', q: 'マダニ 虫除け 防虫スプレー DEET ピカリジン 野外' },
        { kind: 'supplement', label: 'CoQ10・αリポ酸（ミトコンドリア支援・疲労軽減）', q: 'CoQ10 コエンザイム αリポ酸 疲労 ミトコンドリア' }
      ]
    },
    polymyalgia: {
      title: '📚 リウマチ性多発筋痛症・炎症管理のリソース',
      items: [
        { kind: 'book', label: '『リウマチ性多発筋痛症・GCA 患者ガイド』', q: 'リウマチ性多発筋痛症 GCA ステロイド 治療 本' },
        { kind: 'supplement', label: 'カルシウム+ビタミンD3（ステロイド骨粗鬆症予防）', q: 'カルシウム ビタミンD3 サプリ 骨粗鬆症 ステロイド' },
        { kind: 'device', label: '血圧計（ステロイド使用中の高血圧モニタリング）', q: '血圧計 上腕式 自動 家庭用 オムロン' },
        { kind: 'device', label: '骨密度チェック（ステロイド長期使用中）', q: '骨密度 計測 骨粗鬆症 チェック デバイス' }
      ]
    },
    raynauds: {
      title: '📚 レイノー症候群・冷え対策のリソース',
      items: [
        { kind: 'device', label: '電熱手袋（バッテリー加熱・防水・手指レイノー対策）', q: '電熱手袋 加熱 バッテリー 冷え 防水 防寒' },
        { kind: 'device', label: '皮膚温度計（サーモグラフィーアプリ・発作中の温度記録）', q: '皮膚温度計 サーモグラフィ スマートフォン 体表温度' },
        { kind: 'supplement', label: 'マグネシウム・オメガ3（血管平滑筋弛緩・炎症低減）', q: 'マグネシウム オメガ3 血管 炎症 サプリ' },
        { kind: 'book', label: '『強皮症・レイノー症候群 患者セルフケアガイド』', q: '強皮症 レイノー セルフケア 冷え 本' }
      ]
    },
    dissociative: {
    ...
    gastroparesis: {
      ...
      items: [
        { kind: 'device', label: 'CGM（持続血糖測定）フリースタイルリブレ', q: 'CGM フリースタイルリブレ 連続血糖測定 糖尿病' },
        { kind: 'supplement', label: '消化酵素複合（消化補助・食後膨満感軽減）', q: '消化酵素 消化補助 膵臓 腹部膨満 食後' },
        { kind: 'book', label: '『胃不全麻痺・機能性ディスペプシアを克服する食事法』', q: '胃不全麻痺 機能性ディスペプシア 食事 本' },
        { kind: 'device', label: '体重体脂肪計（栄養管理・体重変化モニタリング）', q: '体重計 体脂肪 スマート 栄養管理' }
      ]
    },
    sibo: {
    ...
    pulmonary_fibrosis: {
      ...
      items: [
        { kind: 'device', label: 'パルスオキシメーター（SpO2・脈拍 連続モニタリング）', q: 'パルスオキシメーター 連続 SpO2 モニタリング フィンガー' },
        { kind: 'device', label: '携帯型酸素濃縮器 アクセサリー（外出時用ケース・カート）', q: '在宅酸素 携帯 濃縮器 カート 外出' },
        { kind: 'book', label: '『肺線維症・間質性肺炎の基礎知識』', q: '肺線維症 間質性肺炎 本 患者 ガイド' },
        { kind: 'device', label: '呼吸リハビリ用 インセンティブスパイロメーター', q: 'スパイロメーター 呼吸リハビリ 肺活量 インセンティブ' }
      ]
    },
    cptsd: {
      title: '📚 複雑性PTSD・トラウマ回復のリソース',
      items: [
        { kind: 'book', label: '『身体はトラウマを記録する』（ベッセル・ヴァン・デア・コーク）', q: '身体はトラウマを記録する ヴァン デア コーク' },
        { kind: 'book', label: '『複雑性PTSDから回復する』（ピート・ウォーカー）', q: '複雑性PTSD 回復する 自分を取り戻す' },
        { kind: 'device', label: 'ヘッドバンド型 EEG ニューロフィードバック（脳波安定化）', q: 'EEG ニューロフィードバック ヘッドバンド 瞑想' },
        { kind: 'supplement', label: 'マグネシウム（神経過敏・過覚醒の緩和）', q: 'マグネシウム グリシン 過覚醒 神経 睡眠' }
      ]
    },
    metabolic_syndrome: {
      title: '📚 メタボリックシンドローム改善に役立つリソース',
      items: [
        { kind: 'device', label: '上腕式血圧計（朝・晩 自動記録）', q: '上腕式 血圧計 自動記録 オムロン' },
        { kind: 'device', label: '体組成計（腹囲・内臓脂肪レベル・BMI）', q: '体組成計 内臓脂肪 腹囲 スマート' },
        { kind: 'book', label: '『メタボリックシンドロームを克服する食事と運動』', q: 'メタボリックシンドローム 食事 運動 本' },
        { kind: 'supplement', label: '食後血糖を抑える食物繊維（難消化性デキストリン）', q: '難消化性デキストリン 血糖 食後 特定保健用食品' }
      ]
    },
    celiac: {
      title: '📚 セリアック病・グルテンフリー生活のリソース',
      items: [
        { kind: 'book', label: '『グルテンフリー完全ガイド』', q: 'グルテンフリー 完全ガイド セリアック 本' },
        { kind: 'supplement', label: 'グルテン分解酵素（食前補助用・グルテン消化補助）', q: 'グルテン 消化 酵素 サプリ ブロック' },
        { kind: 'supplement', label: 'ビタミンD+カルシウム（セリアック吸収障害補充）', q: 'ビタミンD カルシウム 吸収 骨粗鬆症' },
        { kind: 'device', label: 'グルテン検査キット（食品・食器のグルテン汚染確認）', q: 'グルテン 検査 キット 食品 残留' }
      ]
    },
    als: {
      title: '📚 ALS（筋萎縮性側索硬化症）の療養・支援リソース',
      items: [
        { kind: 'book', label: '『ALSと生きる―療養の記録と制度活用ガイド』', q: 'ALS 筋萎縮性側索硬化症 療養 患者 本' },
        { kind: 'device', label: '視線入力コミュニケーションデバイス（Eye Gaze）', q: '視線入力 コミュニケーション 意思伝達装置 ALS' },
        { kind: 'device', label: 'パルスオキシメーター（SpO2・脈拍 連続モニタリング）', q: 'パルスオキシメーター 連続 モニタリング SpO2' },
        { kind: 'device', label: '吸引器（口腔内・気道ケア）', q: '吸引器 口腔ケア 痰 気道 家庭用' }
      ]
    },
    hashimoto: {
    ...
    neuropathy: {
      ...
      items: [
        { kind: 'supplement', label: 'αリポ酸（チオクト酸）600mg（糖尿病性神経障害・抗酸化）', q: 'αリポ酸 チオクト酸 サプリ 糖尿病 神経障害 抗酸化' },
        { kind: 'supplement', label: 'メチルコバラミン（活性型ビタミンB12）神経修復サポート', q: 'メチルコバラミン ビタミンB12 サプリ 神経 しびれ' },
        { kind: 'device', label: 'フットケア用品（糖尿病足・足病変予防セット）', q: 'フットケア 糖尿病 足 角質 ケア 保湿 クリーム' },
        { kind: 'book', label: '『神経障害性疼痛・末梢神経障害の管理ガイド』', q: '神経障害性疼痛 末梢神経 管理 プレガバリン 本' }
      ]
    },
    nafld: {
      title: '📚 NAFLD・脂肪肝・肝臓管理のリソース',
      items: [
        { kind: 'book', label: '『非アルコール性脂肪性肝疾患（NAFLD）患者ガイド』', q: 'NAFLD 脂肪肝 NASH 食事 生活習慣 本' },
        { kind: 'supplement', label: 'シリマリン（ミルクシスル）肝保護・抗酸化サプリ', q: 'シリマリン ミルクシスル 肝臓 サプリ 保護 脂肪肝' },
        { kind: 'device', label: '体組成計（内臓脂肪・BMI・筋肉量の継続測定）', q: '体組成計 内臓脂肪 スマート 体重 筋肉量 BMI' },
        { kind: 'supplement', label: 'オメガ3（EPA/DHA）高濃度 — 中性脂肪低下・肝炎症抑制', q: 'オメガ3 EPA DHA 中性脂肪 肝臓 サプリ 高濃度' }
      ]
    },
    hsd: {
      title: '📚 過動性スペクトラム障害・関節過可動症のリソース',
      items: [
        { kind: 'device', label: '関節サポーター（手首・指・膝・足首 — 脱臼防止）', q: '関節 サポーター 手首 膝 足首 過可動 脱臼 防止' },
        { kind: 'device', label: 'キネシオテーピングテープ（関節安定・セルフケア）', q: 'キネシオ テーピング テープ 関節 安定 サポート' },
        { kind: 'supplement', label: 'コラーゲンペプチド＋ビタミンC（結合組織サポート）', q: 'コラーゲン ペプチド ビタミンC サプリ 結合組織 関節' },
        { kind: 'book', label: '『エーラスダンロス症候群・関節過可動性 患者ガイド』', q: 'エーラスダンロス 関節過可動 HSD hEDS 本 患者' }
      ]
    },
    tbi: {
      title: '📚 外傷性脳損傷後遺症・脳震盪回復のリソース',
      items: [
        { kind: 'book', label: '『脳震盪後症候群（PCS）完全回復ガイド：段階的復帰と認知リハビリ』', q: '脳震盪 後症候群 PCS 回復 リハビリ 認知 本' },
        { kind: 'device', label: 'ブルーライトカットメガネ（光過敏・眼精疲労対策）', q: 'ブルーライトカット メガネ 光過敏 眼精疲労 脳震盪' },
        { kind: 'supplement', label: 'オメガ3 DHA/EPA（神経軸索回復・神経炎症抑制）', q: 'オメガ3 DHA EPA サプリ 神経 脳 炎症 回復' },
        { kind: 'device', label: 'スマートウォッチ（活動量・心拍・睡眠の同時記録）', q: 'スマートウォッチ 活動量 心拍 睡眠 記録 Garmin Apple Watch' }
      ]
    },
    ihd: {
      title: '📚 虚血性心疾患・心臓管理のリソース',
      items: [
        { kind: 'device', label: '家庭用血圧計（上腕式・血圧変動の毎日記録）', q: '血圧計 上腕式 家庭用 オムロン 心臓病 日々記録' },
        { kind: 'book', label: '『心臓病（狭心症・心筋梗塞）完全回復ガイド：心臓リハビリと生活習慣改善』', q: '狭心症 心筋梗塞 心臓リハビリ 生活習慣 回復 本' },
        { kind: 'supplement', label: 'オメガ3 EPA/DHA（中性脂肪低下・抗炎症）', q: 'オメガ3 EPA DHA サプリ 中性脂肪 心臓 抗炎症' },
        { kind: 'device', label: 'パルスオキシメーター（SpO2・心拍数モニタリング）', q: 'パルスオキシメーター 酸素飽和度 心拍 家庭用 心臓病' }
      ]
    },
    cancer_survivor: {
      title: '📚 がんサバイバーシップ・治療後管理のリソース',
      items: [
        { kind: 'book', label: '『がんサバイバーシップ：治療後の生活再建と後遺症管理完全ガイド』', q: 'がん サバイバー 治療後 後遺症 疲労 認知 ガイド 本' },
        { kind: 'supplement', label: 'コエンザイムQ10（がん関連疲労・心毒性予防サポート）', q: 'コエンザイムQ10 サプリ がん 疲労 心毒性 サバイバー' },
        { kind: 'device', label: 'スマートウォッチ（歩数・心拍・睡眠の記録 — 運動療法のモニタリング）', q: 'スマートウォッチ 歩数 心拍 睡眠 がん リハビリ 運動' },
        { kind: 'book', label: '『恐怖の再発を乗り越える：がんサバイバーのメンタルケア』', q: 'がん 再発 恐怖 不安 メンタル サバイバー マインドフルネス 本' }
      ]
    },
    chemo_side: {
      title: '📚 化学療法副作用管理のリソース',
      items: [
        { kind: 'book', label: '『抗がん剤の副作用と上手に向き合う完全ガイド』', q: '抗がん剤 副作用 吐き気 骨髄抑制 口内炎 管理 本' },
        { kind: 'supplement', label: 'グルタミン（口腔粘膜炎・腸管保護・免疫サポート）', q: 'グルタミン サプリ 口内炎 粘膜 免疫 抗がん剤' },
        { kind: 'device', label: '体温計（発熱性好中球減少症の早期発見に必須）', q: '体温計 体温 電子 腋下 耳 正確 毎日 発熱' },
        { kind: 'device', label: 'パルスオキシメーター（SpO2・心拍数の在宅モニタリング）', q: 'パルスオキシメーター 酸素 SpO2 心拍 在宅 がん 治療中' }
      ]
    },
    immunodeficiency: {
      title: '📚 免疫不全症・感染予防管理のリソース',
      items: [
        { kind: 'book', label: '『原発性免疫不全症（CVID）患者と家族のための完全ガイド』', q: 'CVID 原発性免疫不全 抗体欠損 IVIG 患者 本 ガイド' },
        { kind: 'device', label: '体温計・パルスオキシメーター（感染の早期発見セット）', q: '体温計 パルスオキシメーター 発熱 感染 早期発見 在宅' },
        { kind: 'supplement', label: 'ビタミンD3（免疫調節・感染予防サポート）', q: 'ビタミンD3 サプリ 免疫 感染 予防 5000IU' },
        { kind: 'book', label: '『感染症予防と免疫：患者向け最新ガイド』', q: '感染症 予防 免疫 ワクチン 抗菌薬 手洗い 患者 本' }
      ]
    },
    mcs: {
      title: '📚 化学物質過敏症・香害対策のリソース',
      items: [
        { kind: 'device', label: '活性炭マスク（有機溶剤・香料フィルタリング）', q: '活性炭 マスク 有機溶剤 化学物質 香料 過敏 MCS' },
        { kind: 'device', label: '空気清浄機（活性炭フィルター付き・VOC除去）', q: '空気清浄機 活性炭 VOC 化学物質 シックハウス 香料 除去' },
        { kind: 'book', label: '『化学物質過敏症・香害：私たちの体と環境を守るガイド』', q: '化学物質過敏症 香害 MCS シックハウス 本 患者 ガイド' },
        { kind: 'supplement', label: '無香料・低刺激洗剤セット（洗濯用・食器用）', q: '無香料 洗剤 柔軟剤なし 低刺激 化学物質過敏 敏感肌' }
      ]
    },
    eating: {
      title: '📚 摂食障害回復サポートのリソース',
      items: [
        { kind: 'book', label: '『摂食障害回復ガイド：自分と食事との関係を再構築する』', q: '摂食障害 回復 神経性やせ症 過食症 食事 関係 本 ガイド' },
        { kind: 'book', label: '『家族のための摂食障害サポートブック（Maudsley法）』', q: '摂食障害 家族 サポート マズレー FBT 回復 本' },
        { kind: 'supplement', label: '電解質補充ドリンク（低栄養・嘔吐後の電解質回復）', q: '電解質 補充 ドリンク カリウム ナトリウム スポーツ 補給' },
        { kind: 'device', label: '体温計（低体温モニタリング — 低栄養状態の指標）', q: '体温計 低体温 体温 測定 低栄養 摂食障害 モニタリング' }
      ]
    },
    substance: {
      title: '📚 依存症回復サポートのリソース',
      items: [
        { kind: 'book', label: '『依存症からの回復：AA・NA・SMART Recovery の実践ガイド』', q: 'アルコール依存 薬物依存 回復 AA NA 本 ガイド 断酒' },
        { kind: 'book', label: '『ニコチン依存症・禁煙完全ガイド（バレニクリン・NRT 併用）』', q: '禁煙 ニコチン依存 バレニクリン 禁煙外来 チャンピックス 本' },
        { kind: 'supplement', label: 'NAC（N-アセチルシステイン）渇望軽減サポート', q: 'NAC N-アセチルシステイン サプリ 渇望 依存 解毒' },
        { kind: 'device', label: 'スマートウォッチ（HRV・睡眠・運動記録 — 回復モニタリング）', q: 'スマートウォッチ 睡眠 HRV 運動 ストレス 依存 回復 記録' }
      ]
    },
    allergy: {
      title: '📚 アレルギー疾患管理のリソース',
      items: [
        { kind: 'supplement', label: 'ビラスチン（第2世代抗ヒスタミン薬 — 眠気少・持続12-24h）', q: '抗ヒスタミン薬 ビラスチン フェキソフェナジン 花粉症 アレルギー 眠気 少ない' },
        { kind: 'device', label: '空気清浄機（HEPAフィルター花粉・ダニアレルゲン除去）', q: '空気清浄機 HEPA 花粉 ダニ アレルゲン 除去 寝室 アトピー' },
        { kind: 'supplement', label: '腸内フローラ改善プロバイオティクス（アレルギー体質改善サポート）', q: 'プロバイオティクス 乳酸菌 ビフィズス菌 アレルギー 腸内 フローラ サプリ' },
        { kind: 'book', label: '『最新版 アレルギー疾患診療ガイド：食物・花粉・アトピー・アナフィラキシー』', q: 'アレルギー 食物 花粉 アナフィラキシー アトピー 診療 ガイド 本' }
      ]
    },
    mold: {
      title: '📚 カビ毒・室内環境改善のリソース',
      items: [
        { kind: 'device', label: '除湿器（室内湿度50%以下維持 — カビ繁殖抑制）', q: '除湿器 コンパクト 室内 湿度 カビ 防止 除湿 デシカント' },
        { kind: 'device', label: '空気清浄機（活性炭+HEPAフィルター — カビ胞子・VOC除去）', q: '空気清浄機 活性炭 HEPA カビ 胞子 VOC 除去 室内' },
        { kind: 'supplement', label: 'グルタチオン（マイコトキシン解毒サポート・抗酸化）', q: 'グルタチオン サプリ 解毒 抗酸化 マイコトキシン カビ毒' },
        { kind: 'device', label: 'デジタル温湿度計（室内環境モニタリング）', q: '温湿度計 デジタル 室内 湿度 カビ 結露 モニタリング' }
      ]
    },
    emf: {
      title: '📚 電磁波環境管理のリソース',
      items: [
        { kind: 'device', label: '電磁波測定器（マルチ電磁波メーター — 自室の電磁場レベル確認）', q: '電磁波 測定器 メーター EMF RF マイクロ波 Wi-Fi 測定' },
        { kind: 'device', label: 'LANケーブル（有線LAN — Wi-Fiを使わない環境整備）', q: 'LANケーブル Cat6 有線 インターネット Wi-Fi 代替' },
        { kind: 'book', label: '『電磁波過敏症・環境過敏症のセルフケアガイド』', q: '電磁波過敏症 EHS 環境過敏症 生活 対策 本 ガイド' },
        { kind: 'supplement', label: 'マグネシウム（神経過敏・頭痛・睡眠改善サポート）', q: 'マグネシウム サプリ 神経 頭痛 睡眠 リラックス 過敏' }
      ]
    }
  };
