...
(function () {
  ...
  var CATALOGS = {
    ...
    cptsd: {
      title: '📚 複雑性PTSD・トラウマ回復に役立つリソース',
      items: [
        { kind: 'book', label: '『身体はトラウマを記録する — 複雑性PTSDの神経生物学』（ベッセル・ヴァン・デア・コーク）', q: '身体はトラウマを記録する ベッセル コーク PTSD 複雑性 神経' },
        { kind: 'book', label: '『複雑性トラウマとその治療 — 段階的アプローチ』', q: '複雑性トラウマ 治療 段階的 CPTSD 心理 本' },
        { kind: 'book', label: '『DBT スキルトレーニングワークブック』感情調節・苦悩耐性', q: 'DBT スキルトレーニング ワークブック 感情調節 弁証法的行動療法' },
        { kind: 'supplement', label: 'アシュワガンダ（コルチゾール調節・ストレス緩和のエビデンスあり）', q: 'アシュワガンダ サプリ コルチゾール ストレス 緩和 エビデンス' }
      ]
    },
    dissociative: {
      title: '📚 解離性障害の理解と回復に役立つリソース',
      items: [
        { kind: 'book', label: '『解離性障害のすべて — DID・離人症・解離性健忘の正しい理解』', q: '解離性障害 DID 離人症 解離 わかりやすい 本 患者 理解' },
        { kind: 'book', label: '『内なる世界を統合する — 解離症・DID 当事者のための自助ガイド』', q: 'DID 解離 統合 当事者 自助 ガイド 本' },
        { kind: 'book', label: '『グラウンディング 101 — 解離・フラッシュバックに役立つ安定化技法』', q: 'グラウンディング 解離 フラッシュバック 安定化 PTSD 本 技法' }
      ]
    },
    immunodeficiency: {
      title: '📚 免疫不全症の管理に役立つリソース',
      items: [
        { kind: 'book', label: '『原発性免疫不全症の診断と治療 — 患者・家族のためのガイド』', q: '原発性免疫不全 CVID 患者 ガイド 診断 治療 本' },
        { kind: 'device', label: '体温計（非接触・外出時の発熱チェック）', q: '体温計 非接触 額 正確 デジタル 外出' },
        { kind: 'device', label: '空気清浄機 HEPA フィルター（空気中の細菌・ウイルス除去）', q: '空気清浄機 HEPA フィルター 細菌 ウイルス 除去 医療' },
        { kind: 'supplement', label: 'ビタミン D（免疫機能強化 4000IU）', q: 'ビタミンD 4000IU サプリ 免疫 強化 欠乏' }
      ]
    },
    cancer_survivor: {
      title: '📚 がんサバイバーシップ・治療後の回復に役立つリソース',
      items: [
        { kind: 'book', label: '『がんサバイバーシップ — 治療後の生活を支える包括的ガイド』', q: 'がん サバイバー 治療後 生活 回復 本 ガイド' },
        { kind: 'book', label: '『がん疲労（CRF）を乗り越える — 倦怠感管理と運動療法の実践』', q: 'がん 疲労 倦怠感 治療後 運動 回復 本' },
        { kind: 'supplement', label: 'ビタミン D（がん後の骨密度低下・免疫サポート）', q: 'ビタミンD サプリ がん 骨粗鬆症 免疫 治療後' },
        { kind: 'device', label: '万歩計・活動量計（有酸素運動でがん疲労改善）', q: '活動量計 万歩計 歩数 運動 がん リハビリ 疲労' },
        { kind: 'book', label: '『骨粗鬆症予防のための食事・運動療法（ホルモン療法後の骨密度管理）』', q: '骨粗鬆症 予防 食事 運動 骨密度 ホルモン療法 本' }
      ]
    },
    mcs: {
      title: '📚 化学物質過敏症（MCS）の対策に役立つリソース',
      items: [
        { kind: 'book', label: '『化学物質過敏症を知る — 症状・環境整備・生活改善の手引き』', q: '化学物質過敏症 MCS 症状 環境 生活 改善 本' },
        { kind: 'device', label: '空気清浄機（HEPA + 活性炭フィルター・VOC 除去）', q: '空気清浄機 HEPA 活性炭 VOC ホルムアルデヒド 化学物質 除去' },
        { kind: 'device', label: 'N95 マスク（活性炭入り・化学物質フィルター）', q: 'マスク 活性炭 N95 化学物質 VOC フィルター 外出' },
        { kind: 'supplement', label: 'グルタチオン（解毒・抗酸化サポート）', q: 'グルタチオン サプリ 解毒 抗酸化 還元型' }
      ]
    },

    celiac: {
      title: '📚 セリアック病のグルテンフリー生活に役立つリソース',
      items: [
        { kind: 'book', label: '『セリアック病・グルテン不耐症 完全ガイド — 食事・栄養・レシピ』', q: 'セリアック病 グルテン不耐症 食事 グルテンフリー 本' },
        { kind: 'supplement', label: 'グルテン分解酵素サプリ（外食時の補助用）', q: 'グルテン 分解 消化酵素 サプリ セリアック' },
        { kind: 'supplement', label: 'マルチビタミン・ミネラル（吸収不良補正）', q: 'マルチビタミン ミネラル 腸 吸収 不良 鉄 葉酸 B12' },
        { kind: 'device', label: 'グルテン検査キット（食材・外食の確認）', q: 'グルテン 検査 キット テスト 食品 外食' }
      ]
    },

    dysautonomia: {
      title: '📚 自律神経障害の生活改善に役立つリソース',
      items: [
        { kind: 'book', label: '『自律神経の整え方 — 生活習慣・呼吸・運動の科学』', q: '自律神経 整える 生活 呼吸 運動 本 失調' },
        { kind: 'device', label: '圧迫ストッキング（起立性低血圧・POTS 対策）', q: '圧迫ストッキング 弾性 医療用 起立性低血圧 POTS 静脈' },
        { kind: 'device', label: '脈波・HRV 計測デバイス（自律神経スコア）', q: 'HRV 心拍変動 自律神経 計測 ウェアラブル スマートウォッチ' },
        { kind: 'supplement', label: '経口補水液・塩分補給（血圧維持）', q: '経口補水液 塩分 補給 OS-1 POTS 低血圧 自律神経' }
      ]
    },
    ...
    metabolic_syndrome: {
      ...
      items: [
        { kind: 'book', label: '『内臓脂肪を落とす — 科学的な食事・運動・生活習慣』', q: '内臓脂肪 メタボ 落とす 食事 運動 生活 本' },
        { kind: 'device', label: 'スマート体組成計（内臓脂肪・筋肉量・BMI 計測）', q: '体組成計 内臓脂肪 スマート Wi-Fi Bluetooth アプリ 連携' },
        { kind: 'device', label: '連続血糖モニター互換品（血糖スパイク可視化）', q: '血糖 センサー フリースタイルリブレ スパイク 可視化 食事 計測' },
        { kind: 'supplement', label: 'ベルベリン（血糖・脂質・腸内細菌叢の改善）', q: 'ベルベリン サプリ 血糖 血糖値 脂質 インスリン抵抗性' }
      ]
    },

    pulmonary_fibrosis: {
      title: '📚 肺線維症の療養生活に役立つリソース',
      items: [
        { kind: 'book', label: '『肺線維症・IPF 患者と家族のためのガイド — 療養・呼吸リハビリ』', q: '肺線維症 IPF 特発性 療養 呼吸 リハビリ 本' },
        { kind: 'device', label: 'パルスオキシメーター（SpO2・脈拍の日常モニタリング）', q: 'パルスオキシメーター SpO2 酸素飽和度 脈拍 家庭用 管理' },
        { kind: 'device', label: '在宅酸素療法用品（携帯型酸素濃縮器アクセサリー）', q: '携帯型 酸素濃縮器 HOT 在宅酸素 アクセサリー 持ち運び' },
        { kind: 'supplement', label: 'N-アセチルシステイン（NAC・抗酸化・粘液調整）', q: 'N-アセチルシステイン NAC サプリ 肺 抗酸化 粘液' }
      ]
    }
  };
