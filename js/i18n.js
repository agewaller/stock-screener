...
var i18n = {
  ...
  translations: {
    ja: {
      ...
      your_records: 'あなたの記録',
      page_title_dashboard: 'ダッシュボード', page_title_data_input: 'データ入力',
      page_title_analysis: 'AI分析', page_title_actions: 'アクションセンター',
      page_title_research: '最新研究', page_title_chat: '相談する',
      page_title_integrations: 'デバイス連携', page_title_timeline: 'タイムライン',
      page_title_admin: '管理パネル', page_title_settings: '設定',
      page_title_privacy: 'プライバシーと安全',
      reminder_title: '毎日の記録リマインダー',
      reminder_enable: 'リマインダーをオン',
      reminder_time: '通知時刻',
      reminder_saved: 'リマインダーを設定しました',
      reminder_denied: '通知の許可が必要です。ブラウザ設定から許可してください。',
    },
    en: {
      ...
      page_title_dashboard: 'Dashboard', page_title_data_input: 'Data Entry',
      page_title_analysis: 'AI Analysis', page_title_actions: 'Action Center',
      page_title_research: 'Research', page_title_chat: 'Consult',
      page_title_integrations: 'Integrations', page_title_timeline: 'Timeline',
      page_title_admin: 'Admin Panel', page_title_settings: 'Settings',
      page_title_privacy: 'Privacy & Safety',
      reminder_title: 'Daily Recording Reminder',
      reminder_enable: 'Enable Reminder',
      reminder_time: 'Notification time',
      reminder_saved: 'Reminder set successfully',
      reminder_denied: 'Notification permission required. Please allow in browser settings.',
    },
    zh: {
      ...
      your_records: '您的记录',
      page_title_dashboard: '仪表盘', page_title_data_input: '数据录入',
      page_title_analysis: 'AI分析', page_title_actions: '行动中心',
      page_title_research: '研究', page_title_chat: '咨询',
      page_title_integrations: '设备连接', page_title_timeline: '时间线',
      page_title_admin: '管理面板', page_title_settings: '设置',
      page_title_privacy: '隐私与安全',
      reminder_title: '每日记录提醒', reminder_enable: '开启提醒',
      reminder_time: '通知时间', reminder_saved: '提醒设置成功',
      reminder_denied: '需要通知权限，请在浏览器设置中允许。',
    },
    ko: {
      ...
      your_records: '나의 기록',
      page_title_dashboard: '대시보드', page_title_data_input: '데이터 입력',
      page_title_analysis: 'AI 분석', page_title_actions: '액션 센터',
      page_title_research: '연구', page_title_chat: '상담',
      page_title_integrations: '기기 연동', page_title_timeline: '타임라인',
      page_title_admin: '관리 패널', page_title_settings: '설정',
      page_title_privacy: '개인정보 및 보안',
      reminder_title: '매일 기록 알림', reminder_enable: '알림 켜기',
      reminder_time: '알림 시간', reminder_saved: '알림을 설정했습니다',
      reminder_denied: '알림 권한이 필요합니다. 브라우저 설정에서 허용해주세요.',
    },
    es: {
      ...
      page_title_dashboard: 'Panel', page_title_data_input: 'Entrada de datos',
      page_title_analysis: 'Análisis IA', page_title_actions: 'Centro de acción',
      page_title_research: 'Investigación', page_title_chat: 'Consultar',
      page_title_integrations: 'Integraciones', page_title_timeline: 'Línea de tiempo',
      page_title_admin: 'Panel admin', page_title_settings: 'Ajustes',
      page_title_privacy: 'Privacidad y seguridad',
      reminder_title: 'Recordatorio diario', reminder_enable: 'Activar recordatorio',
      reminder_time: 'Hora de notificación', reminder_saved: 'Recordatorio configurado',
      reminder_denied: 'Se necesita permiso de notificaciones.',
    },
    fr: {
      ...
      page_title_dashboard: 'Tableau de bord', page_title_data_input: 'Saisie de données',
      page_title_analysis: 'Analyse IA', page_title_actions: 'Centre d\'action',
      page_title_research: 'Recherche', page_title_chat: 'Consulter',
      page_title_integrations: 'Intégrations', page_title_timeline: 'Chronologie',
      page_title_admin: 'Admin', page_title_settings: 'Paramètres',
      page_title_privacy: 'Confidentialité',
      reminder_title: 'Rappel quotidien', reminder_enable: 'Activer le rappel',
      reminder_time: 'Heure de notification', reminder_saved: 'Rappel configuré',
      reminder_denied: 'Permission de notification requise.',
    },
    de: {
      ...
      page_title_dashboard: 'Übersicht', page_title_data_input: 'Dateneingabe',
      page_title_analysis: 'KI-Analyse', page_title_actions: 'Aktionszentrum',
      page_title_research: 'Forschung', page_title_chat: 'Beratung',
      page_title_integrations: 'Integrationen', page_title_timeline: 'Zeitlinie',
      page_title_admin: 'Admin', page_title_settings: 'Einstellungen',
      page_title_privacy: 'Datenschutz',
      reminder_title: 'Tägliche Erinnerung', reminder_enable: 'Erinnerung aktivieren',
      reminder_time: 'Benachrichtigungszeit', reminder_saved: 'Erinnerung gesetzt',
      reminder_denied: 'Benachrichtigungsberechtigung erforderlich.',
    },
    pt: {
      ...
      page_title_dashboard: 'Painel', page_title_data_input: 'Entrada de dados',
      page_title_analysis: 'Análise IA', page_title_actions: 'Central de ações',
      page_title_research: 'Pesquisa', page_title_chat: 'Consultar',
      page_title_integrations: 'Integrações', page_title_timeline: 'Linha do tempo',
      page_title_admin: 'Admin', page_title_settings: 'Configurações',
      page_title_privacy: 'Privacidade',
      reminder_title: 'Lembrete diário', reminder_enable: 'Ativar lembrete',
      reminder_time: 'Hora da notificação', reminder_saved: 'Lembrete configurado',
      reminder_denied: 'Permissão de notificação necessária.',
    },
    th: {
      ...
      page_title_dashboard: 'แดชบอร์ด', page_title_settings: 'ตั้งค่า',
      page_title_data_input: 'บันทึกข้อมูล', page_title_actions: 'ศูนย์การดำเนินการ',
      page_title_research: 'งานวิจัย', page_title_chat: 'ปรึกษา',
      page_title_integrations: 'การเชื่อมต่อ', page_title_timeline: 'ไทม์ไลน์',
      page_title_admin: 'แอดมิน', page_title_analysis: 'การวิเคราะห์ AI',
      page_title_privacy: 'ความเป็นส่วนตัว',
      reminder_title: 'การแจ้งเตือนประจำวัน', reminder_enable: 'เปิดการแจ้งเตือน',
      reminder_time: 'เวลาแจ้งเตือน', reminder_saved: 'ตั้งการแจ้งเตือนสำเร็จ',
      reminder_denied: 'ต้องการสิทธิ์การแจ้งเตือน',
    },
    vi: {
      ...
      page_title_dashboard: 'Bảng điều khiển', page_title_settings: 'Cài đặt',
      page_title_data_input: 'Nhập dữ liệu', page_title_actions: 'Trung tâm hành động',
      page_title_research: 'Nghiên cứu', page_title_chat: 'Tư vấn',
      page_title_integrations: 'Kết nối', page_title_timeline: 'Dòng thời gian',
      page_title_admin: 'Quản trị', page_title_analysis: 'Phân tích AI',
      page_title_privacy: 'Quyền riêng tư',
      reminder_title: 'Nhắc nhở hàng ngày', reminder_enable: 'Bật nhắc nhở',
      reminder_time: 'Giờ thông báo', reminder_saved: 'Đã thiết lập nhắc nhở',
      reminder_denied: 'Cần quyền thông báo.',
    },
    ar: {
      ...
      page_title_dashboard: 'لوحة التحكم', page_title_settings: 'الإعدادات',
      page_title_data_input: 'إدخال البيانات', page_title_actions: 'مركز الإجراءات',
      page_title_research: 'أبحاث', page_title_chat: 'استشارة',
      page_title_integrations: 'التكاملات', page_title_timeline: 'الجدول الزمني',
      page_title_admin: 'الإدارة', page_title_analysis: 'تحليل الذكاء الاصطناعي',
      page_title_privacy: 'الخصوصية والأمان',
      reminder_title: 'تذكير يومي', reminder_enable: 'تفعيل التذكير',
      reminder_time: 'وقت الإشعار', reminder_saved: 'تم تعيين التذكير',
      reminder_denied: 'مطلوب إذن الإشعارات.',
    },
    hi: {
      ...
      page_title_dashboard: 'डैशबोर्ड', page_title_settings: 'सेटिंग्स',
      page_title_data_input: 'डेटा एंट्री', page_title_actions: 'एक्शन सेंटर',
      page_title_research: 'शोध', page_title_chat: 'परामर्श',
      page_title_integrations: 'इंटीग्रेशन', page_title_timeline: 'टाइमलाइन',
      page_title_admin: 'एडमिन', page_title_analysis: 'AI विश्लेषण',
      page_title_privacy: 'गोपनीयता और सुरक्षा',
      reminder_title: 'दैनिक रिमाइंडर', reminder_enable: 'रिमाइंडर चालू करें',
      reminder_time: 'सूचना समय', reminder_saved: 'रिमाइंडर सेट हो गया',
      reminder_denied: 'सूचना अनुमति आवश्यक है।',
    },
  },
