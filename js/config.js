...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    liver_disease: [
      'フィブロスキャン14.2 kPaで肝硬変と診断された。ALT 55に改善中。禁酒2年継続、体重を3ヶ月で3kg減らした。塩分6g/日を目指しているが難しい。',
      '今週のALTは72（前回98）。疲労感が4/10に改善。コーヒー1日3杯続けている。ウルソ服薬継続。次の検査でフィブロスキャン測定予定。'
    ],
    cancer_fatigue: [
      'パクリタキセル3回目後。倦怠感7/10。足のしびれが足首まで広がってきた。デュロキセチン追加で少し楽になった気がする。20分のウォーキングを週3回目標にしている。',
      'CA125が42から28に低下。治療効果があると言われた。CIPN 4/10に改善。吐き気は制吐薬で3/10程度。食欲戻ってきた。'
    ],
    atrial_fibrillation: [
      '昨夜22時から動悸が始まり、今朝5時まで続いた。心拍数が120〜140で、息苦しさもあった。リクシアナ飲み忘れなし。今日受診予定。',
      'アブレーション後3ヶ月経過。今週は発作なし。リハビリで週2回30分のウォーキングを開始。血圧は130/82。脈拍は安静時65。'
    ],
    hypertension: [
      '朝の家庭血圧が150/95と高め。塩分を減らして1週間。体重は75kg。アムロジピン服薬継続。夜の血圧は135/85まで下がってきた。',
      '先週から軽い頭重感がある。今朝の血圧142/88。ウォーキング30分後は125/80に。食塩制限（6g/日）を意識している。'
    ],
    diabetes: [
      '朝の空腹血糖が128。昨日は低糖質の昼食後に血糖が95まで下がり低血糖気味になった。HbA1c先月7.2。メトホルミン継続中。',
      '今週はジョギング3回。血糖コントロールが少し改善。食後2時間血糖が160→140に。インスリン抵抗性に効果が出ている感じ。'
    ],
    default: [
