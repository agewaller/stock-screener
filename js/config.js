...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '右側の頭が脈打つように痛い。吐き気もあって光がまぶしい。鎮痛剤を飲んだが2時間経っても治まらない。',
      '前兆として30分ほど視野に光るギザギザが見えてから頭痛が始まる。月に4〜5回繰り返しており仕事に影響している。'
    ],
    adhd: [
      '集中力が続かず、会議中に関係ない思考が次々と浮かんでしまう。締め切り直前にならないとエンジンがかからない。',
      '大事な予定を忘れてしまったり、物をなくすことが多い。整理整頓ができず部屋と頭が常にカオス状態。'
    ],
    bipolar: [
      '今週は気分が高揚して睡眠3時間でも動けたが、突然落ちてベッドから出られなくなった。このサイクルが怖い。',
      '薬を飲み始めてから波は小さくなったが、気分の浮き沈みはまだある。特に季節の変わり目がつらい。'
    ],
    endometriosis: [
      '生理のたびに下腹部と腰の激痛で動けない。鎮痛剤が効かず毎月仕事を休んでいる。不妊治療も視野に入れている。',
      '生理以外の時期でも骨盤の痛みが続く。婦人科でMRIを撮ったら子宮内膜症と診断された。'
    ],
    chronic_pain: [
      '腰と両膝の痛みが3年以上続いている。鎮痛剤なしでは外出できないが、胃への影響も心配。',
      '痛みの強さが日によって違い、予測できないのがつらい。雨の日と疲れた翌日は特にひどい。'
    ],
    gad: [
      '常に「何か悪いことが起きるのでは」という不安感がある。電話の着信音だけで動悸がして手が震える。',
      '心配が頭から離れず、リラックスできない。夜も不安で眠れず、翌日の疲労感がひどい。'
    ],
    ptsd: [
      'あの出来事の夢を毎週見る。フラッシュバックが突然起きて、何でもない場所で固まってしまうことがある。',
      '特定の音や匂いが引き金になって体が反応する。人混みや騒音が怖くて外出できなくなっている。'
    ],
    cptsd: [
      '感情の調節が難しく、ちょっとしたことで強い怒りや悲しみが出る。自分のことが嫌いで、人を信じられない。',
      '長年のストレスのせいか、ぼんやりして自分の感情が分からないことがある。過去の記憶が唐突によみがえる。'
    ],
    ra: [
      '朝起きると手指がこわばって1時間ほど動かしにくい。関節の腫れと痛みがある。血液検査でRFが陽性。',
      '薬を飲んでいるが天気が悪い日や疲れた時は関節が熱を持つ。仕事でパソコンを打つのがつらくなってきた。'
    ],
    ms: [
      '左半身のしびれが数日前から続いている。過去にも目の見え方がおかしくなったことがあり、MRIを予約した。',
      '再発寛解型で3年ほど経過。疲れると症状が出やすく、夏の暑さで一時的に悪化する（ウートフ現象）。'
    ],
    pcos: [
      '生理が3〜4ヶ月来ないことが続いている。体毛が濃くなり、ニキビも増えた。排卵検査薬が反応しない。',
      'インスリン抵抗性があると言われた。体重管理に取り組んでいるが生理周期がまだ不規則。'
    ],
    thyroid_hypo: [
      'チラーヂン服用中だが疲れやすさと体重増加が続く。TSH は正常範囲内だが FT3 が低めと指摘された。',
      '寒さに弱くなり、髪が抜ける。記憶力も落ちた気がする。甲状腺の薬を始めて半年、まだ慣れない。'
    ],
    hyperthyroidism: [
      '心拍が速く、少し動くだけで汗が出る。体重が減っているのに食欲は旺盛。手が細かく震えている。',
      'チアマゾール服用中。倦怠感と動悸が残っている。次の甲状腺機能検査が心配。'
    ],
    default: [
