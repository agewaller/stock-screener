...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '今朝から右こめかみの拍動性頭痛が続いている。光が眩しくて仕事ができない。トリプタンを飲んだがまだ効いてこない。',
      '前兆として視野に光の点滅が出た後、強い頭痛と吐き気が来た。横になって部屋を暗くして安静にしている。'
    ],
    adhd: [
      '仕事中に集中が続かず、別のことが気になってしまう。大事な締め切りをまた忘れていた。メモを取っても見返す習慣がつかない。',
      '今日は過集中で8時間作業したが、食事もトイレも忘れていた。昨日は逆に何も手がつかなかった。波が激しい。'
    ],
    bipolar: [
      '2週間ほど睡眠が4時間でも元気で、企画書を毎日書いていたが、今週から急にやる気が出ず、ベッドから出られない。',
      '気分の波が読めず、職場の人間関係がうまくいかない。躁の時に言いすぎてしまって後悔することが多い。'
    ],
    endometriosis: [
      '生理中の痛みが鎮痛剤を飲んでも10段階で8以上。仕事を休まざるを得ない。ジエノゲストを処方してもらった。',
      '生理前後に骨盤の鈍痛が続く。排便時の痛みもひどく、チョコレート嚢胞の手術を検討中と言われた。'
    ],
    chronic_pain: [
      '腰から脚にかけての痛みが毎日続いている。ロキソニンを飲み続けているが胃が痛くなってきた。他の選択肢を探したい。',
      '天気が悪い日は特に痛みが強い。痛みで眠れず、睡眠不足で痛みが悪化するという悪循環に入っている。'
    ],
    gad: [
      '仕事のことや家族の健康のことが頭から離れず、常に不安感がある。体の緊張が抜けず、肩こりと頭痛がひどい。',
      '電車の中でも何かあったらどうしようという考えが止まらない。心療内科でSSRIを処方してもらっているが慣れるまでが辛い。'
    ],
    ptsd: [
      '過去の出来事のフラッシュバックが突然来て、その時と同じ恐怖を感じる。夜は悪夢で目が覚めることが多い。',
      '特定の場所や音がトリガーになって気分が悪くなる。人混みが避けられず、外出が怖くなってきた。'
    ],
    cptsd: [
      '感情の起伏が激しく、些細なことで泣いてしまったり怒ってしまったりする。自分が誰なのか分からなくなる感覚がある。',
      '人間関係でまた同じパターンを繰り返している気がする。セラピーで少しずつ気づいていくが、しんどい日も多い。'
    ],
    ra: [
      '朝の手のこわばりが1時間以上続く。関節が腫れて握力が落ちている。MTXを増量してもらったが効果が出るまで時間がかかると言われた。',
      'CRPが上がっていて生物学的製剤の追加を検討中。疲労感も強く、フルタイムの仕事が続けられるか不安。'
    ],
    ms: [
      '左足のしびれと脱力が2週間続いている。MRIで新しい病変が見つかり、インターフェロン製剤の変更を検討中。',
      '視力の一時的な低下（視神経炎）が出て、眼科に紹介された。疲れると症状が悪化するので気温管理が重要と言われた。'
    ],
    pcos: [
      '生理が2〜3ヶ月に1回しか来ない。超音波で多嚢胞卵巣と言われた。ニキビと体毛が気になって婦人科に相談した。',
      'インスリン抵抗性があると言われ、メトホルミンを始めた。妊活中なのでクロミッドも検討中と言われている。'
    ],
    thyroid_hypo: [
      '疲れやすさと冷えが続いている。TSHが高くチラージンを処方してもらったが、適正量になるまで数ヶ月かかると言われた。',
      '体重が半年で5kg増えた。便秘、むくみ、眠気が続いている。チラージンの量を調整中。'
    ],
    hyperthyroidism: [
      '動悸と手の震えが続いている。TSH低下・FT4上昇でバセドウ病と診断された。メルカゾールを始めたばかり。',
      '暑さに弱くなり、汗が増えた。体重が落ちているのに食欲はある。甲状腺エコーで腫大が確認された。'
    ],
    thyroid_hyper: [
      '動悸と手の震えが続いている。TSH低下・FT4上昇でバセドウ病と診断された。メルカゾールを始めたばかり。',
      '暑さに弱くなり、汗が増えた。体重が落ちているのに食欲はある。甲状腺エコーで腫大が確認された。'
