...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '右側頭部にズキズキする拍動性の痛みがある。光と音が苦手で暗い部屋で横になっている。吐き気もある。',
      '予兆として視野の端に光の輪が見えた後、片頭痛が始まった。トリプタンを早めに飲んだが効きが弱い。'
    ],
    adhd: [
      '会議中に何度も話題が頭を飛び出して追えなくなる。メモを取ろうとするが手が動く前に次の話題に移ってしまう。',
      '締め切りのある仕事があるのに気づいたら2時間他のことをしていた。コンサータを飲んでいるが午後に切れる感じがある。'
    ],
    bipolar: [
      '3日間ほとんど眠らなくても疲れず、アイデアが次々と浮かんでアクティブに動けた。今日から急に落ち込んでいる。',
      '混合状態で気分が不安定。エネルギーはあるが焦燥感と涙が同時にくる。リーマスの血中濃度を測りたい。'
    ],
    endometriosis: [
      '生理2日目で腰から太ももにかけて激しい痛み。鎮痛剤が効かず仕事を休んだ。超音波でチョコレートのう胞を指摘されている。',
      '生理以外でも排卵痛と深部性交痛がある。ジェノゲストを3ヶ月続けているが出血が続く。'
    ],
    chronic_pain: [
      '朝起きると腰と膝に痛みがあり動き始めに30分かかる。天気が悪い日は特にひどい。鎮痛剤は胃に負担が大きくて毎日は飲めない。',
      '痛みのせいで夜中に何度も目が覚める。睡眠不足が痛みを悪化させる悪循環になっている気がする。'
    ],
    gad: [
      '特定の理由がないのに「何かが起きるかもしれない」という不安が一日中続く。胃のむかつきと肩こりもひどい。',
      '不安で頭の中がぐるぐるして仕事に集中できない。SSRIを飲み始めて2週間、まだ効果が感じられない。'
    ],
    ptsd: [
      '昨夜また事故のフラッシュバックで眠れなかった。ちょっとした音や気配で体が固まる。人混みが怖い。',
      'EMDRを始めて4回目。セッション後は疲弊するが少しずつ過去の出来事を「過去のこと」として見られるようになってきた。'
    ],
    cptsd: [
      '感情の波が激しく、小さなことで強い恐怖や怒りが来る。自分がどこにいるか分からなくなる離人感が出た。',
      '人と話すと体が固まる。安心できる場所は家だけで外出するのがどんどん難しくなっている。'
    ],
    ra: [
      '朝のこわばりが1時間以上続く。両手の指関節が腫れていて握力がほとんどない。MTX週1回服薬中。',
      'CRP 2.8、DAS28スコアが先月より上がっていた。生物学的製剤への切り替えを主治医と相談している。'
    ],
    ms: [
      '右足に電気が走るような感覚と脱力が出た。MRIで新しい病変が見つかりインターフェロンβを開始することになった。',
      'Uhthoff現象で入浴後しばらく視野がぼやける。疲労が強くて仕事で座っているのもつらい。'
    ],
    pcos: [
      '生理が2〜3ヶ月来ない。超音波でいくつかの小さな嚢胞を確認。男性ホルモン値が高く多毛と肌荒れがひどい。',
      'メトホルミンを開始して1ヶ月。インスリン抵抗性を改善しようとしているが体重がなかなか落ちない。'
    ],
    thyroid_hypo: [
      'チラージンを飲んでいるが疲労感と冷えが抜けない。TSH 5.2でまだ高め。主治医に増量を相談したい。',
      '髪がごっそり抜けて体重も2ヶ月で4kg増えた。便秘と浮腫みもある。甲状腺の次回採血で FT3も測ってもらう予定。'
    ],
    thyroid_hyper: [
      '動悸と手の震えがひどい。体重が1ヶ月で3kg落ちた。眼球が少し突出しているとも言われた。',
      'メルカゾールを飲み始めて3ヶ月。TSHが徐々に正常値に近づいてきたが肝機能が少し上がっていて心配。'
    ],
    default: [
