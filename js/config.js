...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '昨日から右側頭部にズキズキする拍動性の痛みが続いている。吐き気もあり、光が眩しい。市販の鎮痛剤は効かなかった。',
      '月に4〜5回片頭痛が来る。前兆（視野にギザギザが見える）が出てから約20分後に激しい頭痛が始まる。'
    ],
    adhd: [
      '仕事中に注意が散漫になり、締め切りをいくつか見落としてしまった。集中しようとすると逆に頭が真っ白になる。',
      '部屋が片付けられず、物をよく忘れる。話しているとつい話題が飛んでしまい、相手に申し訳ない。'
    ],
    bipolar: [
      '先週は全く眠れないのにエネルギーが溢れていたが、今週は布団から出られない。このサイクルがここ数ヶ月続いている。',
      '躁状態のときに衝動買いをしてしまった。今は気分が沈んでいて後悔している。気分安定薬を飲んでいるが波が残る。'
    ],
    endometriosis: [
      '生理痛がひどく、市販の鎮痛剤では全く効かない。生理中は仕事を休まなければならないほど痛い。',
      '腰痛と下腹部の重い痛みが生理前から始まり、生理が終わっても数日続く。排便時にも痛みがある。'
    ],
    chronic_pain: [
      '3年以上腰と右脚に慢性的な痛みが続いている。動いても安静にしていても痛く、夜眠れないことがある。',
      '痛みのせいで仕事と家事が思うようにできない。痛み止めは胃に悪いので量を減らしたいが、減らすと動けない。'
    ],
    gad: [
      '常に何か悪いことが起きそうな不安感がある。仕事のミス、家族の健康、将来のことが頭から離れない。',
      '緊張で肩と首が常に張っており、夜も眠れない。会議の前日は特に不安で動悸がすることがある。'
    ],
    ptsd: [
      '数年前の出来事が突然フラッシュバックしてくる。特定の場所や音が引き金になることが分かってきた。',
      '夜に悪夢を見て目が覚めることが週に数回ある。人混みにいると常に周囲を警戒してしまい疲れる。'
    ],
    cptsd: [
      '感情の波が激しく、些細なことで強い恐怖や怒りが出てしまう。後から冷静になると自己嫌悪に陥る。',
      '人を信頼することがとても難しい。親しくなりそうになると自分から距離を置いてしまう。'
    ],
    ra: [
      '朝起きると手の指がこわばっていて動かすのに30分以上かかる。関節の腫れと痛みが両手にある。',
      'メトトレキサートを服用中だが、まだ手首と膝の腫れが取れない。疲労感も強く午後になると動けなくなる。'
    ],
    ms: [
      '右足に力が入りにくく、長距離を歩くと引きずってしまう。暑い日は特に症状が悪化する。',
      '再発期間中に視野がぼやけ、右目に痛みがあった。今は落ち着いているが次の再発が怖い。'
    ],
    pcos: [
      '生理が3ヶ月に1度しか来ない。体重が増えやすく、顎に毛が生えてきた。婦人科でPCOSと診断された。',
      '不妊治療中。排卵誘発剤を使っているが反応が不安定。超音波で多数の小さな嚢胞が確認されている。'
    ],
    thyroid_hypo: [
      'チラージンを内服して半年になるが、まだ疲労感と冷えがひどい。TSHは正常値に入ったと言われたが症状が残っている。',
      '体重が増えやすく、便秘がひどい。髪の毛が抜けて量が減ってきた。甲状腺の薬を増量してもらいたい。'
    ],
    thyroid_hyper: [
      '動悸と手の震えが続いている。食欲はあるのに体重が2ヶ月で4kg減った。バセドウ病と診断されてメルカゾールを開始した。',
      '抗甲状腺薬を飲み始めて3週間。動悸は少し落ち着いたが目の違和感（眼球突出が少し）が気になる。'
    ],
    default: [
