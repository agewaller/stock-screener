...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '左側の拍動性頭痛が3時間続いた。吐き気と光の感受性が強い。トリプタンを飲んで少し楽になった。',
      '気圧が下がる前日から首のこわばりと肩こりが始まる。予防的に休息を取ったが発作になった。今月3回目。'
    ],
    adhd: [
      '仕事中に集中が途切れて別のことを始めてしまう。締め切りが迫っているのに手が動かない。ストラテラ服薬中。',
      '物をなくしたり、約束を忘れたりが続いている。マルチタスクが特に苦手で職場でのミスが増えている。'
    ],
    bipolar: [
      '3日間ほぼ眠れず、アイデアが次々と浮かんでとまらない。躁状態かもしれない。リチウムの血中濃度が心配。',
      '気分の波が激しい。先週は過活動だったのに今週は布団から出られない。医師に状態を正確に伝えたい。'
    ],
    endometriosis: [
      '生理痛が鎮痛剤を飲んでも7/10の痛みが続く。仕事を休まざるを得ない。ジエノゲストを開始して3ヶ月。',
      '生理以外の時期にも骨盤の鈍い痛みがある。腸の症状（便秘と下痢）も生理前後に悪化する。'
    ],
    chronic_pain: [
      '腰と両膝の痛みが3ヶ月以上続いている。天気が悪い日は特にひどく、外出が減った。睡眠も浅い。',
      '痛みのせいで好きだったことができない。鎮痛薬の量が増えていることが心配。他の方法を探したい。'
    ],
    gad: [
      'ほぼ毎日、何か悪いことが起きる気がして心配が止まらない。身体の緊張と疲労感が慢性的にある。',
      '仕事でミスをしていないか不安で確認を繰り返してしまう。夜なかなか眠れず、朝もぐったりしている。'
    ],
    ptsd: [
      '夜中に悪夢でうなされて目が覚める。その後眠れない。特定の音や場面でフラッシュバックが起きる。',
      '人混みや大きな音が苦手になった。以前は平気だったのに。トラウマの話をするとパニックになりそうで怖い。'
    ],
    cptsd: [
      '感情が急に揺れて自分でもコントロールできない感覚がある。他者を信頼するのが怖く、対人関係が苦しい。',
      '自分が「まともじゃない」という感覚が常にある。解離状態が続くことがある。カウンセリングを始めたばかり。'
    ],
    ra: [
      '朝のこわばりが1時間以上続き、両手の指が腫れている。MTXとヒュミラを使用中。最近疲労感が強い。',
      'CRPが下がっているが関節痛は残っている。仕事でのキーボード作業が辛い。関節保護の方法を知りたい。'
    ],
    ms: [
      '左足のしびれと脱力が2週間続いている。インターフェロンを打っているが再発が心配。疲労感も強い。',
      'Uhthoff現象で暑い日は症状が悪化する。今日は視野がぼやけた。MRIの予約を早めるか迷っている。'
    ],
    pcos: [
      '生理が3〜4ヶ月来ない。体重が増えやすく、肌荒れとにきびが続く。超音波で多嚢胞を確認されている。',
      '低血糖のような症状が食後2時間で出る。インスリン抵抗性と言われた。食事内容を記録して管理したい。'
    ],
    thyroid_hypo: [
      'チラージン内服中だが体重が増え続けている。寒がりで、髪が抜けやすく、疲労感が抜けない。',
      'TSHが正常範囲でも倦怠感と冷えが強い。ドクターにT3/T4の詳細を相談したい。便秘も気になる。'
    ],
    thyroid_hyper: [
      '動悸と手の震えが続いている。体重が2ヶ月で4kg減った。チアマゾール服薬中だが汗をかきやすい。',
      '眼球が突出してきた気がして怖い。メルカゾールの副作用（白血球減少）が心配で体温を毎日測っている。'
    ],
    default: [
