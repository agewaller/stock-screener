...
var CONFIG = {
  ...
  DISEASE_EPIDEMIOLOGY: {
    ...
    substance:          { world: null, label: '世界推計は策定中',                  tier: 0, density: 'high',
                          japan: null, japanLabel: '国内推計策定中' },
    dvt:                { world:  10_000_000, label: '約 1,000 万人/年 (新規発症)', tier: 2, density: 'medium', source: 'グローバル推計',
                          japan:     35_000, japanLabel: '約 2-4 万人/年',          japanSource: '日本循環器学会推計' },
    pulmonary_fibrosis: { world:   3_000_000, label: '約 300 万人 (推計)',          tier: 2, density: 'high',   source: 'グローバル推計',
                          japan:     20_000, japanLabel: '約 2 万人',               japanSource: '指定難病' },
    nafld:              { world: 1_500_000_000, label: '約 15 億人 (推計)',         tier: 3, density: 'medium', source: '有病率 ~25% 外挿',
                          japan: 10_000_000, japanLabel: '約 1,000 万人 (推計)',    japanSource: '日本消化器病学会' },
    ankylosing:         { world:   1_400_000, label: '約 140 万人 (推計)',          tier: 2, density: 'high',   source: 'グローバル推計',
                          japan:    100_000, japanLabel: '約 2-12 万人 (推計)',     japanSource: '日本リウマチ学会' },
  },
  ...
  FINANCIAL_SUPPORT: [
    {
      ...
      applicable: ['depression', 'bipolar', 'ptsd', 'adhd', 'gad', 'ocd', 'asd'],
    ...
    },
    {
      ...
      applicable: ['mecfs', 'fibromyalgia', 'sle', 'ra', 'crohns', 'uc', 'parkinsons', 'pss', 'ms', 'als', 'pots'],
      professional: 'sharoushi',
      urls: [
    ...
    },
    {
      ...
      applicable: ['depression', 'bipolar', 'ptsd', 'adhd', 'asd'],
      professional: 'sharoushi',
    ...
    },
    {
      ...
      applicable: ['pots', 'als', 'parkinsons', 'ms', 'ra'],
      professional: 'sharoushi',
    ...
    },
    {
      ...
      applicable: ['mecfs', 'als', 'parkinsons', 'ms', 'severe_mental'],
      professional: 'sharoushi',
    ...
    },
    {
      ...
      applicable: ['parkinsons', 'als', 'ra', 'ms'],
      professional: 'sharoushi',
    ...
    },
    {
      ...
      applicable: ['mecfs', 'fibromyalgia', 'sle', 'ra', 'als', 'ms', 'parkinsons'],
      professional: 'sharoushi',
...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    adhd: [
      '今日も締め切り直前まで動けなかった。頭ではわかっているのに体が動かない感覚。コンサータを飲んでいるが午後3時以降はきれる。もっと長く効く薬に変えてもらいたい。',
      '物をなくすのが止まらない。今週だけで鍵を3回なくした。玄関に必ず戻す習慣をつけようとしているが定着しない。記録してパターンを見つけたい。',
      '昨日は会議で感情爆発してしまった。些細な批判に過剰反応してしまう。睡眠不足だったせいもあると思う。睡眠と感情の関係を記録したい。'
    ],
    uc: [
      '今日は朝から血便が出た。昨日外食でスパイスの効いた料理を食べたのが原因かもしれない。下腹部の痛みもある。メサラジンを飲み続けているが最近効きが弱い気がする。',
      '1日8回トイレに行った。夜中も2回起きてしまって睡眠が取れていない。仕事に行けるか不安。先生に連絡すべきか迷っている。',
      '今週は比較的安定していて1日2〜3回になった。便に血も混じっていない。食事に気を付けると違うのかもしれない。記録してパターンを確認したい。'
    ],
    default: [
