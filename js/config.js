...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '左側の拍動性頭痛が4時間続いた。吐き気があり、光と音が辛い。トリプタンを飲んで少し楽になった。',
      '前駆症状で首のこわばりと光過敏あり。気圧の変化と関係しているかも。今日は痛みは来なかった。',
      '今月3回目の発作。月経2日前に起きやすいパターンがある。ホルモンとの関連を医師に相談したい。'
    ],
    adhd: [
      '今日も締め切りを忘れてしまった。タスク管理アプリを使い始めたが、通知に気づかないことも多い。',
      '集中しようとすると別のことが気になってしまう。1時間に何度も席を立つ。薬を飲んだ日は少しマシ。',
      '話している途中で相手の言葉を遮ってしまった。衝動性のコントロールが難しい日だった。'
    ],
    bipolar: [
      '今週は睡眠が3〜4時間なのに全く眠くない。アイデアが次々浮かんで止まらない。躁転かもしれない。',
      '2週間ぶりにベッドから出られた。気分の波が来るたびに仕事と人間関係が影響を受けるのが辛い。',
      '今日は気分が安定している。リーマスの血中濃度の結果待ち。服薬を続けていることが支えになっている。'
    ],
    endometriosis: [
      '生理3日目、痛みが10段階で9。ロキソプロフェンでも取れず、横になるしかない。仕事を休んだ。',
      '生理痛以外に排卵期にも骨盤の重だるさがある。チョコレート嚢腫のフォローアップ中。',
      '腸の痛みと下痢が生理に連動している。深部子宮内膜症を疑われて腹腔鏡検査を検討中。'
    ],
    chronic_pain: [
      '腰と脚の痛みが続いて5年になる。良い日・悪い日の波があり、今日は8/10の強さだった。',
      '痛みのせいで集中できず、仕事の効率が落ちている。ペインクリニックの予約を入れた。',
      '天気が悪くなると痛みが増す傾向がある。痛み日記をつけ始めてパターンが見えてきた。'
    ],
    gad: [
      '些細なことが気になって頭が止まらない。今日は外出できなかった。緊張と肩こりがひどい。',
      '「また失敗するかも」という考えが出ると手が止まる。認知行動療法を試し始めた。',
      '昨日より少し楽。深呼吸とジャーナリングを続けている。完璧主義を手放す練習中。'
    ],
    ptsd: [
      '夜中にフラッシュバックで目が覚めた。3時間しか眠れなかった。今日は人混みを避けた。',
      'トリガーになる場面を避けて生活しているが、気づかないうちに疲弊している。',
      'EMDR療法2回目。セッション後は疲れるが少しずつ変化を感じている。'
    ],
    cptsd: [
      '感情の波が激しく、些細なことで過去の記憶が戻ってくる。今日は安全な場所にいることを確認する必要があった。',
      '人との距離感がうまく取れない。身近な人を傷つけてしまいそうで怖い。セラピーに通っている。',
      '今日は「解離」がひどかった。気づいたら数時間経っていた。グラウンディングの練習をした。'
    ],
    ra: [
      '朝のこわばりが1時間続いた。両手の指関節が腫れていて、コップを持つのが難しい。',
      'メトトレキサートを飲み始めて3ヶ月。CRPが下がってきたが倦怠感は続いている。',
      '寒くなると関節の痛みが増す。今日は湯たんぽを使って手を温めた。少し楽になった。'
    ],
    ms: [
      '右足のしびれが3日前から続いている。MRIの予約を入れた。疲れると症状が悪化する傾向がある。',
      '今日はウートフ現象で暑さのあとに視野がぼやけた。エアコンをつけて休んだら回復した。',
      '再発から2ヶ月経ち、インターフェロンを再開した。疲労コントロールのために休憩を挟んでいる。'
    ],
    pcos: [
      '生理が3ヶ月来ていない。体重が増えやすく、ニキビも続いている。ホルモン検査の結果待ち。',
      '超音波で嚢胞が確認されたと言われた。ピルを試すか相談中。インスリン抵抗性があるかも。',
      '今日は倦怠感と気分の落ち込みがひどい。PMDDとPCOSが重なっているのかもしれない。'
    ],
    thyroid_hypo: [
      'チラージン75μgを飲んでいるがまだ疲れやすい。TSH 3.8で正常範囲内と言われたが症状が残る。',
      '体重が2ヶ月で3kg増えた。便秘と冷え、髪の毛の抜け落ちが続いている。FT3も測ってほしい。',
      '今日は集中力が全くなく、頭がぼんやりしている。甲状腺の数値が安定するまでもう少し。'
    ],
    thyroid_hyper: [
      '動悸と手の震えが続いている。バセドウ病の診断から半年。メルカゾールを服用中。',
      '汗をかきやすく、暑がりが続く。体重が減り、食欲があるのに痩せる。眼球が出てきた気がする。',
      '今日は心拍が100を超えていた。β遮断薬を追加してもらった。睡眠の質が悪い。'
    ],
    default: [
