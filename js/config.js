...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    migraine: [
      '左側の拍動性頭痛8/10。嘔気あり。トリプタン服薬で2時間後に軽減したが、今日は寝て過ごした。',
      '前駆症状（首のこわばり・光感受性）が昨日から。発作は来なかった。気圧低下が関係しているかも。',
      '今月の発作は3回。予防薬を始めてから減ってきた。トリガーは赤ワインと睡眠不足。'
    ],
    adhd: [
      'タスクを始めても10分で別のことに気がとられる。仕事の締め切りが重なると頭がフリーズする。',
      'コンサータ服薬開始2週間。集中できる時間が2時間→4時間になった。食欲は落ちている。',
      '忘れ物を3つした。リマインダーを設定しても通知を無視してしまう。段取りが苦手。'
    ],
    bipolar: [
      '3日間ほとんど眠れずアイデアが溢れていたが、今週は気力ゼロでベッドから出られない。',
      '躁状態のとき衝動的に買い物をしてしまい後悔している。気分安定薬を飲み始めて1ヶ月。',
      '睡眠リズムが安定すると気分も安定する気がする。今日は7時間眠れた。普通の日。'
    ],
    endometriosis: [
      '生理2日目、鎮痛剤が効かないほどの痛み。仕事を休んだ。腰と下腹部が引き裂かれるよう。',
      'ルナベル内服3ヶ月目。生理痛は8→5/10に軽減。ただ不正出血と吐き気がある。',
      '生理以外の時期も骨盤痛が続く。性交痛も。次の外来でMRI結果を聞く予定。'
    ],
    chronic_pain: [
      '全身の深部痛が続いて4年。今日は腰と脚が特につらい。痛み5/10。天気が悪いと悪化する。',
      'リリカで少し楽になったが眠気がひどい。リハビリ後は一時的に痛みが増すが翌日は少しマシ。',
      '痛みで夜眠れず朝は疲弊している。ペインクリニックの受診予約をした。'
    ],
    gad: [
      '「もし〇〇だったら」という考えが止まらない。職場でのミスが頭を離れない。肩が張っている。',
      'SSRI開始1ヶ月。漠然とした不安は少し和らいだ。でも初めての場所に行くのがまだ怖い。',
      '今日は比較的落ち着いていた。腹式呼吸を5分続けたら緊張がほぐれた。'
    ],
    ptsd: [
      '昨夜また悪夢を見た。目が覚めて動悸がひどく、朝まで眠れなかった。フラッシュバックが続く。',
      'トラウマ記憶を思い出すシーンが映画にあって離席した。回避行動が増えている気がする。',
      'EMDRセッション後は消耗するが、少しずつ記憶の感情的な重みが軽くなっている感覚。'
    ],
    cptsd: [
      '些細なことで「自分は価値がない」という感覚に飲み込まれる。感情の波が激しい一日だった。',
      '解離して気づいたら2時間経っていた。現実感がない。身体がよそよそしく感じる。',
      '今日はグラウンディングがうまくできた。足の裏を床につけて呼吸に集中する練習を続けている。'
    ],
    ra: [
      '朝のこわばりが1時間続いた。両手の指関節に腫脹あり。MTX服薬中、次回の採血が気になる。',
      'ヒュミラ注射の翌日は疲れるが、こわばりは30分程度に短縮。CRPが下がってきた。',
      '今日は握力が戻ってきた感じがした。炎症が落ち着いているのかもしれない。'
    ],
    ms: [
      '右足のしびれが3日続いている。夏の暑さで症状が悪化しやすい（ウートフ現象）。涼しくすると楽。',
      '疲労感が強く、午後は何もできない。MSの疲労は普通の疲れと違って、休んでも回復しない感じ。',
      'インターフェロン注射の副作用の発熱が昨夜あった。今日は落ち着いている。'
    ],
    pcos: [
      '生理が2ヶ月来ていない。体重増加と多毛が気になる。ホルモン検査でLH/FSH比が高かった。',
      'メトホルミン開始2ヶ月。生理が40日周期で来るようになった。インスリン抵抗性の改善を期待。',
      '低GI食を意識している。体重が1.5kg減り、排卵の兆候（基礎体温の上昇）が確認できた。'
    ],
    thyroid_hypo: [
      '疲労感と体重増加が続く。チラージン服薬中だがTSHがまだ高め。冷えと便秘もひどい。',
      '髪が抜けやすく、肌が乾燥している。チラージンを25→50μgに増量して2週間。',
      '今日は比較的調子が良かった。TSH 2.3で先月より改善。ただまだ疲れやすい。'
    ],
    thyroid_hyper: [
      '動悸と手の震えが続く。体重が1ヶ月で3kg落ちた。TSHが測定感度以下、FT4が高値。',
      'メルカゾール開始4週間。動悸は少し落ち着いたが、白血球減少が心配で毎週採血している。',
      '暑くて汗が止まらない。眼球が少し出ている気がする（バセドウ眼症の可能性）。眼科紹介予定。'
    ],
    default: [
