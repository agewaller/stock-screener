...
var CONFIG = {
  ...
  AI_MODELS: [
    ...
    { id: 'claude-opus-4-6', name: 'Claude Opus 4.6', provider: 'Anthropic', description: '高精度（旧版）' },
...
### 出力形式（必ず JSON のみ、前後の説明なし）
{
  ...
  GUEST_SAMPLES: {
    ...
    gerd: [
      '夕食後2時間で胸やけと喉の違和感。昨夜は脂っこいものを食べたせいか就寝後も逆流感で目が覚めた。タケキャブは食前に飲み忘れた。',
      '最近また症状が出てきた。コーヒーを飲むと30分以内に胸焼けが起きる。体重が2kg増えたのも関係しているかもしれない。'
    ],
    obesity: [
      '今朝の体重68.2kg。ウゴービ2回目の注射から1週間。食欲が確かに減っている。でも夕食後の甘いもの欲求がまだ残る。',
      '今週の体重記録：68.5→68.2→67.9kg。少しずつ減っている。ウエストはまだ変わらず86cm。運動は週3回のウォーキング20分継続中。'
    ],
    als: [
      '右手の握力がまた落ちた気がする。箸が少し持ちにくくなってきた。疲れると特に悪化する。リルゾール服薬継続中、肝機能検査は先月正常だった。',
      '今日のALSFRS-R採点：先月より1点低下。嚥下項目が少し落ちた。食事時間が長くなっている。栄養士への相談を検討したい。'
    ],
    metabolic_syndrome: [
      '今朝の体重77.2kg、腹囲89cm。血圧138/88（昨日より少し高い）。今日の夕食は外食で塩分が多かったかもしれない。歩数は6200歩。',
      '今月の特定健診結果が来た。腹囲88cm、血糖108、中性脂肪162、HDL42。去年より少し改善している。特定保健指導の面談予約を入れた。'
    ],
    celiac: [
      '今日は外食で醤油が入ったものを食べてしまった。2時間後から腹痛と腹部膨満感。グルテンに反応しているかもしれない。明日の体調が心配。',
      'グルテンフリー食4週目。腹痛の頻度が明らかに減った。倦怠感も少し楽になった気がする。米粉パスタが意外においしかった。'
    ],
    cptsd: [
      '今日は職場でのひとことがトリガーになってフラッシュバック。動悸と手の震えが30分続いた。5-4-3-2-1グラウンディングで少し落ち着けた。',
      'カウンセリング後の翌日は感情が不安定になりやすい。今日も泣けてきた。でも「記録する」ことで少し自分を客観視できている気がする。'
    ],
    pulmonary_fibrosis: [
      '今朝のSpO2は安静時96%、階段を上ったら92%に下がった。咳は3回。ピルフェニドン3錠×3回服薬継続中。食後の気持ち悪さは最近落ち着いてきた。',
      'FVC結果が届いた：前回比3%低下（74%→71%）。6ヶ月で3%だから今のところ許容範囲。次回の受診で主治医と相談したい。呼吸リハを週2回開始した。'
    ],
    dysautonomia: [
      '今朝の起立試験：臥位64bpm→立位2分後101bpm（+37bpm）。めまいと動悸あり。塩分タブレット1錠飲んで少し楽になった。HRV 38ms（低い）。',
      '昨日は気温28度で長時間外出。帰宅後に激しい倦怠感と動悸。熱環境での症状悪化パターンが明確。電解質ドリンクを持ち歩くようにした。'
    ],
    sibo: [
      '昼食後1時間で腹部膨満とガスがひどい。今日は玉ねぎ入りの料理を食べた。これが原因かもしれない。リファキシミン4日目、まだ症状が続いている。',
      '低FODMAP食3週目。膨満感が明らかに減ってきた。以前は食後毎回ひどかったのに、今日は軽かった。何が効いているのか記録して整理したい。'
    ],
    gastroparesis: [
      '昨夕食後から悪心がひどく今朝も残っている。昨日は脂肪の多い食事だった。ドンペリドン3錠×3回服薬中。今日は全粥と豆腐で様子を見る。',
      '体重がまた500g減った。食事が少量しか入らない。食後は必ず30分座って休んでいる。先生に経鼻栄養の話を聞いてみようか検討中。'
    ],
    dissociative: [
      '今日は会議中に急に「ガラス越しに自分を見ている」感覚が来た。30分ほど続いた。地に足をつける呼吸法をやったら少し戻ってきた。',
      '昨日のセラピーの後、夜に記憶の空白があって3時間分覚えていない。翌朝気づいたら部屋の様子が少し変わっていた。先生に話す。'
    ],
    lyme: [
      '北海道旅行から2週間後に太ももの内側に輪状の赤みが出て、発熱と関節痛が始まった。感染症内科でライム病と診断。ドキシサイクリン服薬開始3日目。',
      '抗生物質を3週間飲み終わったが、まだ疲労とブレインフォグが続く。仕事中に集中力が保てない。PTLDSの可能性もあると言われている。'
    ],
    polymyalgia: [
      '今朝も両肩のこわばりで起き上がれなかった。1時間以上かかった。プレドニゾロン15mgを食後に飲んだら昼ごろには少し楽になった。CRP値を確認したい。',
      '3ヶ月かけてステロイドを7mgまで減らしたが、また肩と腰が痛くなってきた。再燃かもしれない。先週から頭痛も少しある。次回の受診で先生に相談する。'
    ],
    raynauds: [
      '今日は最低気温3度でスーパーの冷凍食品コーナーを通っただけで両手の指が白→青になった。電熱手袋をはめたら10分で戻った。アムロジピン5mgを継続中。',
      '今朝の発作は15分ほどで収まった。でも左人差し指の先端に小さな傷ができていた。潰瘍になりそうで怖い。次回の受診で先生に見てもらう。'
    ],
    tbi: [
      '先月の交通事故から7週間。今日は午前中に会議に出たら頭痛が7/10まで悪化して午後は何もできなかった。Berlin プロトコルの段階3で止まっている。',
      '昨日は短い散歩（30分）だけにして症状は4/10程度で安定した。光過敏が少し改善してきた気がする。睡眠は6時間とれた。認知リハビリの先生に報告する。'
    ],
    neuropathy: [
      '夜になると足の裏が焼けるように痛くてよく眠れない。糖尿病8年目。HbA1c 7.8%。プレガバリン75mgを飲み始めて1週間、まだ効果は出ていない。',
      '今朝足の指に小さな傷があった。感覚が鈍くて気づかなかった。フットケア科に予約した。プレガバリンを150mgに増量してもらって昨晩は少し楽に眠れた。'
    ],
    nafld: [
      '先週の健診でAST 48・ALT 62・γGTP 89と全部引っかかった。体重は88kg。脂肪肝と言われた。まず食事を改善することにした。清涼飲料は今日からやめた。',
      '3週間で1.5kg減った。毎朝30分ウォーキングしている。食後血糖も少し落ち着いてきた。次の受診まで継続する。FIB-4インデックスを先生に計算してもらう予定。'
    ],
    hsd: [
      '昨日体育の授業で膝が外れた。また亜脱臼。今日も痛くて歩きにくい。ベイトンスコア7点あると言われたが学校では理解されない。サポーターを全部位につけて登校した。',
      'リハビリの先生に教えてもらったコアトレーニングを1ヶ月続けた。脱臼の頻度が少し減った気がする。POTSの起立時めまいはまだある。水分をしっかり摂るようにしている。'
    ],
    dvt: [
      '先月の長距離フライトから3日後に左足がむくんで赤くなり、DVTと診断された。リバーロキサバン15mg×2回服薬開始。出血に気をつけながら仕事を続けている。',
      '3ヶ月の抗凝固療法が終わる予定。先生に延長が必要か確認する。圧迫ストッキングは毎日着用している。今のところ再発の兆候はない。'
    ],
    adrenal: [
      '朝から激しい倦怠感と低血圧。収縮期血圧90mmHg。ヒドロコルチゾンを倍量（20mg）にした。昨日から軽い発熱があった。シックデイルール通りに対応。',
      '最近用量が合っているのか自信がない。朝の倦怠感がまだある。次回の受診でコルチゾール日内変動の検査をお願いしようと思っている。塩分渇望は落ち着いている。'
    ],
    ihd: [
      '午前中に階段を3階まで上がったら胸の圧迫感が出た。5分で消えた。ニトロは使わず。血圧 128/78、脈拍 62。アスピリン・スタチン・β遮断薬は服薬済み。',
      '今日の心臓リハビリは30分ウォーキング。息切れなし、疲労度 3/10。体重 68.2kg（昨日と同じ）。LDL 最新値は先月 62mg/dL。次回外来まで運動継続予定。'
    ],
    cancer_survivor: [
      '化学療法終了から半年。疲労は 6/10 でまだ続いている。今日は30分散歩ができた。ケモブレインで会議中に言葉が出にくい。足先のしびれ（CIPN）は変わらず 4/10。',
      '次の受診が近いと再発不安が強くなる。不安 7/10。体の異変をすべてがんと結びつけてしまう。運動は週3回維持できている。ホルモン療法の関節痛は朝が特につらい。'
    ],
    chemo_side: [
      '本日 AC 療法2コース目。吐き気 5/10。制吐薬（グラニセトロン+アプレピタント）を服薬したが昼から悪化。体温 36.9℃。夕方から倦怠感強い。口内炎が少し出てきた。',
      '投与後4日目。遅発性の吐き気がまだある。体温 37.2℃ で少し高め。好中球減少期なので感染注意。食欲がなく昨日の食事は通常の 50%。体重が -1.5kg になっていた。'
    ],
    immunodeficiency: [
      'IVIG 投与から3週間。IgGトラフ値 620mg/dL（前回 580mg/dL）。今日は副鼻腔の重さはあるが発熱なし。予防的アジスロマイシンを服薬中。体温 36.8℃。',
      '先週から下痢が続いている。ランブル鞭毛虫の既往があるため主治医に相談予定。体温 37.0℃。倦怠感 4/10。次回のIVIG投与は10日後。IgGトラフ測定のため早めに採血予約した。'
    ],
    mcs: [
      '電車内で隣の方の柔軟剤の香りで頭痛 7/10・倦怠感強い。活性炭マスクを着けていたが今日は特に強かった。自宅に戻って2時間で症状は 3/10 まで回復。',
      '今日は在宅だったため無症状。換気と空気清浄機をフル稼働。外出回数が減るにつれて少し気持ちが塞ぐ感じがある。次回受診で先生に相談してみようと思っている。'
    ],
    eating: [
      '朝食はヨーグルト半分食べられた。昼は食欲がなくてスキップしてしまった。夕方からめまいがある。体温 35.8℃。栄養士さんのアドバイスを思い出しながら夕食は少し食べた。',
      '今日は過食衝動が強かった（不安 8/10）。深呼吸と散歩で気を紛らわして、衝動は収まった。明日の栄養士との面談を楽しみにしている。服薬（ビタミンB群）継続中。'
    ],
    substance: [
      '今日で断酒 14日目。渇望は昼過ぎが 6/10 で特につらかった。スポンサーに電話して乗り越えられた。ナルトレキソン服薬継続中。夜はよく眠れた。',
      '昨日の職場の飲み会で1杯だけ飲んでしまった。今日から再スタート。AA のミーティングに行く予定。バレニクリンは継続中。渇望は3/10。自分を責めすぎないようにしている。'
    ],
    allergy: [
      'スギ花粉の季節が始まった。朝から鼻水とくしゃみがひどい。フェキソフェナジン服用済みだが効果は 50%。目の痒みが 6/10。シダキュア は2年目継続中。',
      '今日は花粉が少なかったようで症状は軽め（鼻水 3/10）。ダニアレルギーの方が今週は気になる。布団の洗濯と掃除機がけを実施。抗ヒスタミン薬は毎朝継続。'
    ],
    mold: [
      '自宅にいると頭痛 6/10 とブレインフォグがひどい。外出すると少し楽になる気がする。除湿器を購入して設置した。カビ検査を業者に依頼予定。',
      '今日は外出（カフェ）で作業したら症状が 3/10 まで改善。自宅との差が大きい。空気清浄機の活性炭フィルターを交換した。室内湿度は今日は 52% まで下がった。'
    ],
    emf: [
      '職場のWi-Fiが強い場所にいると頭痛 5/10 と眼の疲れ。スマートフォンを机から遠ざけたら少し楽になった気がする。夜は機内モードにして寝てみた。',
      '今日は農村に外出。スマートフォンをオフにして過ごしたが症状は 2/10 と軽かった。比較のために明日は普段通りに過ごして記録してみる。'
    ],
    default: [
