...
3. 💪 励ましと次のステップ（継続のモチベーション）`;
  ...
  buildVerifiedActionLinks(diseases, profile) {
    ...
    const diseaseTerms = {
      ...
      allergy: { ja: 'アレルギー疾患 アトピー 食物アレルギー 花粉症 アレルギー科', en: 'allergy specialist allergic disease immunotherapy' },
      gerd: { ja: '逆流性食道炎 GERD 胸やけ 消化器内科', en: 'GERD acid reflux gastroenterology' },
      nafld: { ja: '脂肪肝 NAFLD MASH 肝臓内科 消化器内科', en: 'NAFLD MASH fatty liver hepatology' },
      sibo: { ja: 'SIBO 小腸内細菌増殖症 腸内細菌 消化器内科 機能性消化器疾患', en: 'SIBO small intestinal bacterial overgrowth gastroenterology' },
      gastroparesis: { ja: '胃不全麻痺 胃排出遅延 消化器内科', en: 'gastroparesis gastric emptying gastroenterology' },
      raynauds: { ja: 'レイノー症候群 レイノー現象 膠原病内科 リウマチ科', en: 'Raynaud syndrome rheumatology vascular' },
      polymyalgia: { ja: 'リウマチ性多発筋痛症 PMR リウマチ科', en: 'polymyalgia rheumatica rheumatology' },
      mcs: { ja: '化学物質過敏症 MCS 環境医学 アレルギー科', en: 'multiple chemical sensitivity environmental medicine' },
      chemo_side: { ja: '化学療法後遺症 CIPN 腫瘍内科 抗がん剤', en: 'chemotherapy side effects CIPN oncology' },
      hsd: { ja: '関節過可動性症候群 HSD 整形外科 リハビリ', en: 'hypermobility spectrum disorder physiotherapy' },
      immunodeficiency: { ja: '免疫不全症 IgG 血液内科 免疫内科', en: 'immunodeficiency immunology IgG replacement' },
      substance: { ja: '依存症 アルコール依存 薬物依存 精神科 断酒', en: 'substance use disorder addiction psychiatry' },
      eating: { ja: '摂食障害 拒食症 過食症 心療内科 精神科', en: 'eating disorder anorexia nervosa bulimia' },
      dissociative: { ja: '解離性障害 DID 離人症 精神科 心療内科 トラウマ', en: 'dissociative disorder DID trauma therapy' },
      cptsd: { ja: '複雑性PTSD CPTSD トラウマ 精神科 心療内科 EMDR', en: 'complex PTSD developmental trauma EMDR' },
      dvt: { ja: '深部静脈血栓症 DVT 肺塞栓症 DOAC 循環器内科', en: 'deep vein thrombosis DVT anticoagulation' },
      cancer_survivor: { ja: 'がんサバイバー 術後管理 腫瘍内科', en: 'cancer survivor survivorship care oncology' },
      pulmonary_fibrosis: { ja: '肺線維症 間質性肺疾患 IPF 呼吸器内科', en: 'pulmonary fibrosis ILD IPF nintedanib' },
      tbi: { ja: '外傷性脳損傷 TBI 高次脳機能障害 神経内科 リハビリ', en: 'traumatic brain injury rehabilitation neurology' },
      adrenal: { ja: '副腎機能不全 副腎不全 内分泌内科 ヒドロコルチゾン', en: 'adrenal insufficiency cortisol endocrinology' },
      diabetes_t1: { ja: '1型糖尿病 インスリン CGM 糖尿病内科', en: 'type 1 diabetes insulin pump CGM' },
      emf: { ja: '電磁波過敏症 EHS 環境医学 心療内科 神経内科', en: 'electromagnetic hypersensitivity environmental medicine' },
      mold: { ja: 'カビ毒症 マイコトキシン CIRS 機能性医学 環境医学', en: 'mold illness CIRS mycotoxin functional medicine' },
      lyme: { ja: 'ライム病 感染症内科 ボレリア 神経ライム病', en: 'Lyme disease chronic Lyme infectious disease' },
      dysautonomia: { ja: '自律神経失調症 自律神経障害 神経内科 循環器内科', en: 'dysautonomia autonomic dysfunction neurology' },
      thyroid_hypo: { ja: '甲状腺機能低下症 レボチロキシン 内分泌内科 TSH', en: 'hypothyroidism levothyroxine TSH endocrinology' },
      als: { ja: '筋萎縮性側索硬化症 ALS 神経内科 リルゾール', en: 'ALS motor neuron disease riluzole neurology' },
      arrhythmia: { ja: '不整脈 動悸 循環器内科 ホルター心電図', en: 'cardiac arrhythmia cardiology holter' },
      celiac: { ja: 'セリアック病 グルテン不耐症 消化器内科 グルテンフリー食', en: 'celiac disease gluten intolerance gastroenterology' },
      ihd: { ja: '虚血性心疾患 狭心症 冠動脈疾患 循環器内科 心臓リハビリ', en: 'ischemic heart disease coronary artery angina cardiology' },
      metabolic_syndrome: { ja: 'メタボリックシンドローム 内臓脂肪 肥満 生活習慣病 内科', en: 'metabolic syndrome insulin resistance cardiovascular risk' },
      neuropathy: { ja: '末梢神経障害 多発神経炎 神経内科 しびれ', en: 'peripheral neuropathy nerve damage neurology' },
      obesity: { ja: '肥満症 BMI GLP-1 内分泌内科 生活習慣病', en: 'obesity GLP-1 agonist weight management metabolic' },
    };
  ...
  async loadDashResearch() {
    ...
    const diseaseTerms = {
      ...
      allergy: 'allergic disease IgE atopic march immunotherapy outcomes',
      gerd: 'gastroesophageal reflux disease GERD PPI esophageal pH impedance',
      nafld: 'NAFLD MASH hepatic steatosis resmetirom FIB-4 liver fibrosis',
      sibo: 'small intestinal bacterial overgrowth SIBO rifaximin breath test treatment',
      gastroparesis: 'gastroparesis gastric emptying scintigraphy prokinetic treatment',
      raynauds: 'Raynaud phenomenon primary secondary vasospasm nifedipine calcium channel',
      polymyalgia: 'polymyalgia rheumatica corticosteroid tapering giant cell arteritis',
      mcs: 'multiple chemical sensitivity environmental intolerance idiopathic chronic',
      chemo_side: 'chemotherapy induced peripheral neuropathy CIPN prevention treatment',
      hsd: 'hypermobility spectrum disorder joint hypermobility physiotherapy proprioception',
      immunodeficiency: 'primary secondary immunodeficiency CVID IVIG subcutaneous immunoglobulin',
      substance: 'substance use disorder alcohol opioid buprenorphine naltrexone treatment',
      eating: 'anorexia nervosa bulimia eating disorder recovery weight restoration CBT',
      dissociative: 'dissociative identity disorder depersonalization derealization trauma treatment',
      cptsd: 'complex PTSD developmental trauma NET EMDR treatment outcome',
      dvt: 'deep vein thrombosis DVT anticoagulation DOAC recurrence prevention',
      cancer_survivor: 'cancer survivorship CIPN fatigue exercise late effects quality of life',
      pulmonary_fibrosis: 'idiopathic pulmonary fibrosis IPF nintedanib pirfenidone progression outcomes',
      tbi: 'traumatic brain injury concussion cognitive rehabilitation neurological outcomes',
      adrenal: 'adrenal insufficiency cortisol replacement hydrocortisone crisis prevention',
      diabetes_t1: 'type 1 diabetes closed-loop insulin pump CGM HbA1c outcomes autoimmune',
      emf: 'electromagnetic hypersensitivity idiopathic environmental intolerance IEI-EMF',
      mold: 'mold exposure chronic inflammatory response CIRS mycotoxin indoor air quality',
      lyme: 'Lyme disease Borrelia post-treatment persistent symptoms outcome',
      dysautonomia: 'dysautonomia autonomic nervous system POTS syncope treatment',
      thyroid_hypo: 'hypothyroidism levothyroxine T4 TSH thyroid hormone replacement outcomes',
      als: 'amyotrophic lateral sclerosis ALS riluzole edaravone survival disease progression',
      arrhythmia: 'cardiac arrhythmia anti-arrhythmic therapy holter catheter ablation',
      celiac: 'celiac disease gluten free diet mucosal healing serological remission',
      ihd: 'ischemic heart disease coronary artery disease PCI statin secondary prevention',
      metabolic_syndrome: 'metabolic syndrome insulin resistance GLP-1 lifestyle cardiovascular risk',
      neuropathy: 'peripheral neuropathy diabetic neuropathy pain duloxetine pregabalin treatment',
      obesity: 'obesity GLP-1 receptor agonist semaglutide tirzepatide bariatric weight loss',
    };
...
${titles}`;
  ...
  async autoLoadResearchPage() {
    ...
    const diseaseTerms = {
      ...
      allergy: 'allergic disease IgE atopic dermatitis asthma food allergy immunotherapy',
      gerd: 'GERD proton pump inhibitor esophageal reflux symptoms outcomes',
      nafld: 'MASH NAFLD hepatic steatosis fibrosis resmetirom treatment',
      sibo: 'SIBO small intestinal bacterial overgrowth rifaximin breath test',
      gastroparesis: 'gastroparesis gastric emptying prokinetic treatment outcomes',
      raynauds: 'Raynaud phenomenon vasospasm nifedipine cold exposure management',
      polymyalgia: 'polymyalgia rheumatica prednisone giant cell arteritis outcomes',
      mcs: 'multiple chemical sensitivity environmental intolerance treatment outcomes',
      chemo_side: 'chemotherapy induced peripheral neuropathy CIPN prevention treatment outcomes',
      hsd: 'hypermobility spectrum disorder HSD physiotherapy proprioception outcomes',
      immunodeficiency: 'primary immunodeficiency CVID IVIG subcutaneous immunoglobulin outcomes',
      substance: 'substance use disorder addiction buprenorphine naltrexone harm reduction outcomes',
      eating: 'eating disorder anorexia nervosa bulimia nervosa CBT weight restoration recovery',
      dissociative: 'dissociative disorder DID trauma treatment EMDR outcomes',
      cptsd: 'complex PTSD EMDR trauma-focused therapy outcomes',
      dvt: 'deep vein thrombosis DOAC anticoagulation recurrence prevention',
      cancer_survivor: 'cancer survivorship quality of life exercise fatigue late effects',
      pulmonary_fibrosis: 'pulmonary fibrosis IPF nintedanib pirfenidone antifibrotic outcomes',
      tbi: 'traumatic brain injury rehabilitation cognitive outcomes neuroplasticity',
      adrenal: 'adrenal insufficiency cortisol replacement stress dosing crisis outcomes',
      diabetes_t1: 'type 1 diabetes closed loop insulin CGM glycemic control outcomes',
      emf: 'electromagnetic sensitivity environmental intolerance IEI-EMF psychophysiology',
      mold: 'mold illness CIRS indoor mold mycotoxin health outcomes',
      lyme: 'Lyme disease post-treatment persistent symptoms Borrelia outcomes',
      dysautonomia: 'autonomic dysfunction dysautonomia POTS treatment outcomes',
      thyroid_hypo: 'hypothyroidism levothyroxine thyroid hormone TSH outcomes quality of life',
      als: 'ALS amyotrophic lateral sclerosis riluzole disease progression survival outcome',
      arrhythmia: 'arrhythmia antiarrhythmic ablation rhythm control holter outcomes',
      celiac: 'celiac disease gluten free diet intestinal recovery non-responsive outcomes',
      ihd: 'ischemic heart disease PCI statin PCSK9 secondary prevention outcomes',
      metabolic_syndrome: 'metabolic syndrome GLP-1 lifestyle weight loss cardiometabolic risk',
      neuropathy: 'peripheral neuropathy pain duloxetine pregabalin treatment outcomes',
      obesity: 'obesity semaglutide tirzepatide GLP-1 weight loss metabolic outcomes',
    };
    const terms = diseases.map(d => diseaseTerms[d]).filter(Boolean);
    const query = terms.length > 0 ? `(${terms.join(' OR ')})` : 'chronic disease management';
...
${responseText.substring(0, 3000)}`;
  ...
  _buildShareText(newApproach) {
    ...
    const diseaseHashtag = {
      ...
      gad: '#全般性不安障害', ocd: '#強迫性障害',
      epilepsy: '#てんかん', burnout: '#バーンアウト', parkinsons: '#パーキンソン病',
      ms: '#多発性硬化症', chronic_pain: '#慢性疼痛',
      panic: '#パニック障害', endometriosis: '#子宮内膜症',
      diabetes: '#糖尿病', diabetes_t1: '#1型糖尿病', diabetes_t2: '#2型糖尿病',
      atopy: '#アトピー性皮膚炎', asthma: '#気管支喘息',
      ckd: '#慢性腎臓病CKD', heart_failure: '#心不全', gout: '#痛風',
      osteoporosis: '#骨粗鬆症', menopause: '#更年期障害',
      schizophrenia: '#統合失調症', alzheimers: '#アルツハイマー病認知症',
      sad: '#社会不安障害', anorexia: '#摂食障害', eating: '#摂食障害',
      thyroid_cancer: '#甲状腺がん', thyroid_hypo: '#甲状腺機能低下症',
      hyperthyroidism: '#バセドウ病甲状腺機能亢進症',
      sleep_apnea: '#睡眠時無呼吸症候群', copd: '#COPD',
      liver_disease: '#慢性肝疾患', cancer_fatigue: '#がん治療副作用',
      cancer_survivor: '#がんサバイバー',
      hypertension: '#高血圧', hyperlipidemia: '#脂質異常症', anemia: '#貧血',
      allergic_rhinitis: '#アレルギー性鼻炎', allergy: '#アレルギー疾患',
      psoriasis: '#乾癬', chronic_urticaria: '#慢性蕁麻疹',
      pms_pmdd: '#PMS月経前症候群', overactive_bladder: '#過活動膀胱',
      tinnitus: '#耳鳴り', vertigo: '#めまい',
      dry_eye: '#ドライアイ', chronic_prostatitis: '#慢性前立腺炎',
      ulcerative_colitis: '#潰瘍性大腸炎',
      ankylosing_spondylitis: '#強直性脊椎炎',
      narcolepsy: '#ナルコレプシー過眠症', osteoarthritis: '#変形性関節症',
      sjogrens: '#シェーグレン症候群', atrial_fibrillation: '#心房細動',
      myasthenia: '#重症筋無力症', pcos: '#多嚢胞性卵巣症候群PCOS',
      gerd: '#逆流性食道炎', nafld: '#脂肪肝NAFLD',
      sibo: '#SIBO小腸内細菌増殖', gastroparesis: '#胃不全麻痺',
      raynauds: '#レイノー症候群', polymyalgia: '#リウマチ性多発筋痛症',
      mcs: '#化学物質過敏症', chemo_side: '#化学療法後遺症',
      hsd: '#関節過可動性症候群', immunodeficiency: '#免疫不全症',
      substance: '#依存症回復', dissociative: '#解離性障害',
      cptsd: '#複雑性PTSD', dvt: '#深部静脈血栓症',
      pulmonary_fibrosis: '#肺線維症', tbi: '#高次脳機能障害TBI',
      adrenal: '#副腎機能不全', emf: '#電磁波過敏症EHS',
      mold: '#カビ毒マイコトキシン症', lyme: '#ライム病',
      dysautonomia: '#自律神経失調症', als: '#筋萎縮性側索硬化症ALS',
      arrhythmia: '#不整脈', celiac: '#セリアック病グルテン不耐症',
      ihd: '#虚血性心疾患', metabolic_syndrome: '#メタボリックシンドローム',
      neuropathy: '#末梢神経障害', obesity: '#肥満症'
    }[primaryId] || '#慢性疾患';
