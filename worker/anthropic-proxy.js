...
function extractDiseaseIds(text) {
  ...
  const patterns = {
    ...
    low_back_pain: /慢性腰痛|腰椎椎間板ヘルニア|脊柱管狭窄症|坐骨神経痛|間欠性跛行|腰痛.*しびれ|腰痛.*NRS|硬膜外ブロック|プレガバリン.*腰|リリカ.*腰/i,
    glaucoma: /緑内障|正常眼圧緑内障|眼圧.*高|視野狭窄.*眼|ラタノプロスト|キサラタン|チモロール.*目|ハンフリー視野|視神経乳頭陥凹|OCT.*緑内障|点眼.*緑内障/i,
    ...
    low_back_pain: /慢性腰痛|腰椎椎間板ヘルニア|脊柱管狭窄症|腰部脊柱管|坐骨神経痛|間欠性跛行|chronic low back pain|lumbar disc herniation|spinal stenosis|プレガバリン.*腰|リリカ.*腰|デュロキセチン.*腰|サインバルタ.*腰|硬膜外ブロック|腰痛.*NRS|腰痛.*下肢しびれ|ODIスコア|SLRテスト|腰椎MRI|腰椎すべり症|脊椎すべり|腰痛.*ペインクリニック/i,
    glaucoma: /緑内障|open.angle glaucoma|正常眼圧緑内障|\bNTG\b.*目|glaucoma|眼圧.*上昇|眼圧.*高い|視野狭窄.*眼|ラタノプロスト|キサラタン|トラボプロスト|トラバタンズ|タフルプロスト|タプロス|チモロール.*目薬|ベタキソロール.*目薬|カルテオロール.*目薬|ドルゾラミド|リパスジル|グラナテック|ブリモニジン|アイファガン|RNFL菲薄化|視神経乳頭陥凹|C\/D比.*目|ハンフリー視野|MDスコア.*視野|OCT.*緑内障|トラベクレクトミー|SLT.*緑内障|点眼継続.*緑内障/i,
  };
